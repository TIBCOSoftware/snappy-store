...
public class GfxdRemoveGatewayEventErrorHandlerMessage extends AbstractGfxdReplayableMessage {
  ...
  public GfxdRemoveGatewayEventErrorHandlerMessage() {
  }
  ...
  public void execute() throws StandardException {
    ...
    try {
      ...
      if (logger.infoEnabled()) {
        logger.info("GfxdRemoveGatewayEventErrorHandlerMessage: Executing with fields as: "
            + this.toString());
      }
      CallbackProcedures.removeGfxdGatewayEventErrorHandlerLocally();
    } catch (Exception ex) {
      if (logger.fineEnabled()) {
        logger.fine("GfxdRemoveGatewayEventErrorHandlerMessage#execute: exception encountered", ex);
      }
      ...
      if (contextSet) {
        try {
          ...
          if (logger.fineEnabled()) {
            logger.fine("GfxdRemoveGatewayEventErrorHandlerMessage#execute: exception encountered",
                ex);
          }
        }
  ...
  public byte getGfxdID() {
    return GfxdRemoveGatewayEventErrorHandlerMessage.REMOVE_GATEWAY_EVENT_ERROR_HANDLER_MSG;
  }
  ...
  public Object getKeyToConflate() {
    return GfxdSetGatewayEventErrorHandlerMessage.CONFLATION_KEY_PREFIX;
  }
