/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.db.BasicDatabase
...
public abstract class BasicDatabase implements ModuleControl, ModuleSupportable, PropertySetCallback, Database, JarReader
{
...
// GemStone changes END
    ...
    /**
     * @see com.pivotal.gemfirexd.internal.iapi.db.Database#failover(String)
     */
	...
	*/
	...
	{ 
			...
			cfDB = (ClassFactory) Monitor.bootServiceModule(create, this,
					com.pivotal.gemfirexd.internal.iapi.reference.Module.ClassFactory, startParams);
	}
	...
	*/
	...
	protected void bootValidation(boolean create, Properties startParams)
		...
		pf = (PropertyFactory) Monitor.bootServiceModule(create, this,
			com.pivotal.gemfirexd.internal.iapi.reference.Module.PropertyFactory, startParams);
	}
