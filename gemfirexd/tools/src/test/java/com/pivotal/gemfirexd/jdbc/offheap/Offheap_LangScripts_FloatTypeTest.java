...
import com.pivotal.gemfirexd.jdbc.LangScripts_FloatTypesTest;

public class Offheap_LangScripts_FloatTypeTest extends LangScripts_FloatTypesTest {

  public static void main(String[] args) {
    TestRunner.run(new TestSuite(Offheap_LangScripts_FloatTypeTest.class));
  }

  public Offheap_LangScripts_FloatTypeTest(String name) {
    super(name);
  }
