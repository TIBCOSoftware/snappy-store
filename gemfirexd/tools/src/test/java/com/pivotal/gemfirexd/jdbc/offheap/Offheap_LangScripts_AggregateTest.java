...
import com.pivotal.gemfirexd.jdbc.LangScripts_AggregateTest;

public class Offheap_LangScripts_AggregateTest extends LangScripts_AggregateTest {

  public static void main(String[] args) {
    TestRunner.run(new TestSuite(Offheap_LangScripts_AggregateTest.class));
  }

  public Offheap_LangScripts_AggregateTest(String name) {
    super(name);
  }
