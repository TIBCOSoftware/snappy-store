...
import com.pivotal.gemfirexd.jdbc.LangScripts_SubqueryFlatteningTest;
import junit.framework.TestSuite;
import junit.textui.TestRunner;

public class Offheap_LangScripts_SubqueryFlatteningTest extends LangScripts_SubqueryFlatteningTest {

  public static void main(String[] args) {
    TestRunner.run(new TestSuite(Offheap_LangScripts_SubqueryFlatteningTest.class));
  }

  public Offheap_LangScripts_SubqueryFlatteningTest(String name) {
    super(name);
  }
