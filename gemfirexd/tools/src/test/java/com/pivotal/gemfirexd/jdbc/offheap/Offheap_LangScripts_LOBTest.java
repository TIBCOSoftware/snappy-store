...
import com.pivotal.gemfirexd.jdbc.LangScripts_LOBTest;
import junit.framework.TestSuite;
import junit.textui.TestRunner;

public class Offheap_LangScripts_LOBTest extends LangScripts_LOBTest {

  public static void main(String[] args) {
    TestRunner.run(new TestSuite(Offheap_LangScripts_LOBTest.class));
  }

  public Offheap_LangScripts_LOBTest(String name) {
    super(name);
  }
