...
import com.pivotal.gemfirexd.jdbc.LangScripts_InnerJoinTest;
import junit.framework.TestSuite;
import junit.textui.TestRunner;

public class Offheap_LangScripts_InnerJoinTest extends LangScripts_InnerJoinTest {

  public static void main(String[] args) {
    TestRunner.run(new TestSuite(Offheap_LangScripts_InnerJoinTest.class));
  }

  public Offheap_LangScripts_InnerJoinTest(String name) {
    super(name);
  }
