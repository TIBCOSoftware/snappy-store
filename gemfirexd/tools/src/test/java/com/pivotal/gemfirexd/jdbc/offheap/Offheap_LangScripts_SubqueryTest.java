...
import com.pivotal.gemfirexd.jdbc.LangScripts_SubqueryTest;
import junit.framework.TestSuite;
import junit.textui.TestRunner;

public class Offheap_LangScripts_SubqueryTest extends LangScripts_SubqueryTest {

  public static void main(String[] args) {
    TestRunner.run(new TestSuite(Offheap_LangScripts_SubqueryTest.class));
  }

  public Offheap_LangScripts_SubqueryTest(String name) {
    super(name);
  }
