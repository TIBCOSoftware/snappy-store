...
public final class ColumnValue extends org.apache.thrift.TUnion<ColumnValue, ColumnValue._Fields> {
  ...
  private static final org.apache.thrift.protocol.TField JSON_VAL_FIELD_DESC = new org.apache.thrift.protocol.TField("json_val", org.apache.thrift.protocol.TType.STRUCT, (short)20);
  private static final org.apache.thrift.protocol.TField JAVA_VAL_FIELD_DESC = new org.apache.thrift.protocol.TField("java_val", org.apache.thrift.protocol.TType.STRING, (short)21);
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    JSON_VAL((short)20, "json_val"),
    JAVA_VAL((short)21, "java_val");
  ...
  static {
    ...
    tmpMap.put(_Fields.NULL_VAL, new org.apache.thrift.meta_data.FieldMetaData("null_val", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
    tmpMap.put(_Fields.JSON_VAL, new org.apache.thrift.meta_data.FieldMetaData("json_val", org.apache.thrift.TFieldRequirementType.DEFAULT, 
  ...
  public static ColumnValue date_val(DateTime value) {
    ColumnValue x = new ColumnValue();
    x.setDate_val(value);
    return x;
  }

  public static ColumnValue time_val(DateTime value) {
    ColumnValue x = new ColumnValue();
    x.setTime_val(value);
    return x;
  }

  public static ColumnValue timestamp_val(Timestamp value) {
    ColumnValue x = new ColumnValue();
  ...
  public static ColumnValue json_val(JSONObject value) {
    ColumnValue x = new ColumnValue();
    x.setJson_val(value);
    return x;
  }
  ...
  protected void checkType(_Fields setField, Object value) throws ClassCastException {
    switch (setField) {
      ...
      case DATE_VAL:
        ...
        throw new ClassCastException("Was expecting value of type DateTime for field 'date_val', but got " + value.getClass().getSimpleName());
      case TIME_VAL:
        if (value instanceof DateTime) {
          break;
        }
        throw new ClassCastException("Was expecting value of type DateTime for field 'time_val', but got " + value.getClass().getSimpleName());
      case TIMESTAMP_VAL:
        if (value instanceof Timestamp) {
          break;
        }
        throw new ClassCastException("Was expecting value of type Timestamp for field 'timestamp_val', but got " + value.getClass().getSimpleName());
      case BINARY_VAL:
      ...
      case JSON_VAL:
        ...
        throw new ClassCastException("Was expecting value of type JSONObject for field 'json_val', but got " + value.getClass().getSimpleName());
      case JAVA_VAL:
        if (value instanceof ByteBuffer) {
          break;
        }
      ...
      switch (setField) {
        ...
        case TIMESTAMP_VAL:
          if (field.type == TIMESTAMP_VAL_FIELD_DESC.type) {
            ...
            timestamp_val = new Timestamp();
            timestamp_val.read(iprot);
            return timestamp_val;
          } else {
            org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field.type);
            return null;
        ...
        case ARRAY_VAL:
          if (field.type == ARRAY_VAL_FIELD_DESC.type) {
            List<ColumnValue> array_val;
            {
              ...
              array_val = new ArrayList<>(_list182.size);
              ColumnValue _elem183;
              for (int _i184 = 0; _i184 < _list182.size; ++_i184)
              {
                _elem183 = new ColumnValue();
                _elem183.read(iprot);
                array_val.add(_elem183);
              }
              iprot.readListEnd();
            }
            return array_val;
        ...
        case MAP_VAL:
          if (field.type == MAP_VAL_FIELD_DESC.type) {
            Map<ColumnValue,ColumnValue> map_val;
            {
              ...
              map_val = new HashMap<>(2 * _map185.size);
              ColumnValue _key186;
              ColumnValue _val187;
              for (int _i188 = 0; _i188 < _map185.size; ++_i188)
              {
                _key186 = new ColumnValue();
                _key186.read(iprot);
                _val187 = new ColumnValue();
                _val187.read(iprot);
                map_val.put(_key186, _val187);
              }
              iprot.readMapEnd();
            }
            return map_val;
        ...
        case STRUCT_VAL:
          if (field.type == STRUCT_VAL_FIELD_DESC.type) {
            List<ColumnValue> struct_val;
            {
              ...
              struct_val = new ArrayList<>(_list189.size);
              ColumnValue _elem190;
              for (int _i191 = 0; _i191 < _list189.size; ++_i191)
              {
                _elem190 = new ColumnValue();
                _elem190.read(iprot);
                struct_val.add(_elem190);
              }
              iprot.readListEnd();
            }
            return struct_val;
        ...
        case JSON_VAL:
          if (field.type == JSON_VAL_FIELD_DESC.type) {
            JSONObject json_val;
            json_val = new JSONObject();
            json_val.read(iprot);
            return json_val;
          } else {
            org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field.type);
  ...
  protected void standardSchemeWriteValue(org.apache.thrift.protocol.TProtocol oprot)
    ...
    switch (setField_) {
      ...
      case DECIMAL_VAL:
        ...
        return;
      case DATE_VAL:
        DateTime date_val = (DateTime)value_;
        date_val.write(oprot);
        return;
      case TIME_VAL:
        DateTime time_val = (DateTime)value_;
        time_val.write(oprot);
        return;
      case TIMESTAMP_VAL:
        Timestamp timestamp_val = (Timestamp)value_;
        timestamp_val.write(oprot);
        return;
      case BINARY_VAL:
      ...
      case ARRAY_VAL:
        List<ColumnValue> array_val = (List<ColumnValue>)value_;
        {
          ...
          for (ColumnValue _iter192 : array_val)
          {
      ...
      case MAP_VAL:
        Map<ColumnValue,ColumnValue> map_val = (Map<ColumnValue,ColumnValue>)value_;
        {
          ...
          for (Map.Entry<ColumnValue, ColumnValue> _iter193 : map_val.entrySet())
          {
      ...
      case STRUCT_VAL:
        List<ColumnValue> struct_val = (List<ColumnValue>)value_;
        {
          ...
          for (ColumnValue _iter194 : struct_val)
          {
      ...
      case NULL_VAL:
        ...
        return;
      case JSON_VAL:
        JSONObject json_val = (JSONObject)value_;
        json_val.write(oprot);
        return;
      case JAVA_VAL:
      ...
      switch (setField) {
        ...
        case ARRAY_VAL:
          List<ColumnValue> array_val;
          {
            ...
            array_val = new ArrayList<>(_list195.size);
            ColumnValue _elem196;
            for (int _i197 = 0; _i197 < _list195.size; ++_i197)
            {
              _elem196 = new ColumnValue();
              _elem196.read(iprot);
              array_val.add(_elem196);
            }
            iprot.readListEnd();
          }
          return array_val;
        case MAP_VAL:
          Map<ColumnValue,ColumnValue> map_val;
          {
            ...
            map_val = new HashMap<>(2 * _map198.size);
            ColumnValue _key199;
            ColumnValue _val200;
            for (int _i201 = 0; _i201 < _map198.size; ++_i201)
            {
              _key199 = new ColumnValue();
              _key199.read(iprot);
              _val200 = new ColumnValue();
              _val200.read(iprot);
              map_val.put(_key199, _val200);
            }
            iprot.readMapEnd();
          }
          return map_val;
        case STRUCT_VAL:
          List<ColumnValue> struct_val;
          {
            ...
            struct_val = new ArrayList<>(_list202.size);
            ColumnValue _elem203;
            for (int _i204 = 0; _i204 < _list202.size; ++_i204)
            {
              _elem203 = new ColumnValue();
              _elem203.read(iprot);
              struct_val.add(_elem203);
            }
            iprot.readListEnd();
          }
          return struct_val;
  ...
  public void setDate_val(DateTime value) {
    if (value == null) throw new NullPointerException();
  ...
  public void setTime_val(DateTime value) {
    if (value == null) throw new NullPointerException();
  ...
  public void setTimestamp_val(Timestamp value) {
    if (value == null) throw new NullPointerException();
  ...
  public JSONObject getJson_val() {
    if (getSetField() == _Fields.JSON_VAL) {
      return (JSONObject)getFieldValue();
    } else {
      throw new RuntimeException("Cannot get field 'json_val' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }

  public void setJson_val(JSONObject value) {
    if (value == null) throw new NullPointerException();
  ...
  public boolean isSetJson_val() {
    return setField_ == _Fields.JSON_VAL;
  }
