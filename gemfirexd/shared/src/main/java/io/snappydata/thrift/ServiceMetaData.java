            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.sqlKeywords = new ArrayList<String>(_list36.size);
                String _elem37;
                for (int _i38 = 0; _i38 < _list36.size; ++_i38)
                {
                  _elem37 = iprot.readString();
                  struct.sqlKeywords.add(_elem37);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.numericFunctions = new ArrayList<String>(_list39.size);
                String _elem40;
                for (int _i41 = 0; _i41 < _list39.size; ++_i41)
                {
                  _elem40 = iprot.readString();
                  struct.numericFunctions.add(_elem40);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.stringFunctions = new ArrayList<String>(_list42.size);
                String _elem43;
                for (int _i44 = 0; _i44 < _list42.size; ++_i44)
                {
                  _elem43 = iprot.readString();
                  struct.stringFunctions.add(_elem43);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.systemFunctions = new ArrayList<String>(_list45.size);
                String _elem46;
                for (int _i47 = 0; _i47 < _list45.size; ++_i47)
                {
                  _elem46 = iprot.readString();
                  struct.systemFunctions.add(_elem46);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.dateTimeFunctions = new ArrayList<String>(_list48.size);
                String _elem49;
                for (int _i50 = 0; _i50 < _list48.size; ++_i50)
                {
                  _elem49 = iprot.readString();
                  struct.dateTimeFunctions.add(_elem49);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.supportedCONVERT = new HashMap<SnappyType,Set<SnappyType>>(2*_map51.size);
                SnappyType _key52;
                Set<SnappyType> _val53;
                for (int _i54 = 0; _i54 < _map51.size; ++_i54)
                {
                  _key52 = io.snappydata.thrift.SnappyType.findByValue(iprot.readI32());
                  {
                    org.apache.thrift.protocol.TSet _set55 = iprot.readSetBegin();
                    _val53 = new HashSet<SnappyType>(2*_set55.size);
                    SnappyType _elem56;
                    for (int _i57 = 0; _i57 < _set55.size; ++_i57)
                    {
                      _elem56 = io.snappydata.thrift.SnappyType.findByValue(iprot.readI32());
                      _val53.add(_elem56);
                    }
                    iprot.readSetEnd();
                  }
                  struct.supportedCONVERT.put(_key52, _val53);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.transactionDefaults = new HashMap<TransactionAttribute,Boolean>(2*_map58.size);
                TransactionAttribute _key59;
                boolean _val60;
                for (int _i61 = 0; _i61 < _map58.size; ++_i61)
                {
                  _key59 = io.snappydata.thrift.TransactionAttribute.findByValue(iprot.readI32());
                  _val60 = iprot.readBool();
                  struct.transactionDefaults.put(_key59, _val60);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.supportedFeatures = new HashSet<ServiceFeature>(2*_set62.size);
                ServiceFeature _elem63;
                for (int _i64 = 0; _i64 < _set62.size; ++_i64)
                {
                  _elem63 = io.snappydata.thrift.ServiceFeature.findByValue(iprot.readI32());
                  struct.supportedFeatures.add(_elem63);
                }
                iprot.readSetEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.featuresWithParams = new HashMap<ServiceFeatureParameterized,List<Integer>>(2*_map65.size);
                ServiceFeatureParameterized _key66;
                List<Integer> _val67;
                for (int _i68 = 0; _i68 < _map65.size; ++_i68)
                {
                  _key66 = io.snappydata.thrift.ServiceFeatureParameterized.findByValue(iprot.readI32());
                  {
                    org.apache.thrift.protocol.TList _list69 = iprot.readListBegin();
                    _val67 = new ArrayList<Integer>(_list69.size);
                    int _elem70;
                  ...
                  struct.featuresWithParams.put(_key66, _val67);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ServiceMetaData struct) throws org.apache.thrift.TException {
      ...
      if (struct.sqlKeywords != null) {
        oprot.writeFieldBegin(SQL_KEYWORDS_FIELD_DESC);
        {
          ...
          for (String _iter72 : struct.sqlKeywords)
          {
      ...
      if (struct.numericFunctions != null) {
        oprot.writeFieldBegin(NUMERIC_FUNCTIONS_FIELD_DESC);
        {
          ...
          for (String _iter73 : struct.numericFunctions)
          {
      ...
      if (struct.stringFunctions != null) {
        oprot.writeFieldBegin(STRING_FUNCTIONS_FIELD_DESC);
        {
          ...
          for (String _iter74 : struct.stringFunctions)
          {
      ...
      if (struct.systemFunctions != null) {
        oprot.writeFieldBegin(SYSTEM_FUNCTIONS_FIELD_DESC);
        {
          ...
          for (String _iter75 : struct.systemFunctions)
          {
      ...
      if (struct.dateTimeFunctions != null) {
        oprot.writeFieldBegin(DATE_TIME_FUNCTIONS_FIELD_DESC);
        {
          ...
          for (String _iter76 : struct.dateTimeFunctions)
          {
      ...
      if (struct.supportedCONVERT != null) {
        oprot.writeFieldBegin(SUPPORTED_CONVERT_FIELD_DESC);
        {
          ...
          for (Map.Entry<SnappyType, Set<SnappyType>> _iter77 : struct.supportedCONVERT.entrySet())
          {
            oprot.writeI32(_iter77.getKey().getValue());
            {
              oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, _iter77.getValue().size()));
              for (SnappyType _iter78 : _iter77.getValue())
              {
      ...
      if (struct.transactionDefaults != null) {
        oprot.writeFieldBegin(TRANSACTION_DEFAULTS_FIELD_DESC);
        {
          ...
          for (Map.Entry<TransactionAttribute, Boolean> _iter79 : struct.transactionDefaults.entrySet())
          {
            oprot.writeI32(_iter79.getKey().getValue());
            oprot.writeBool(_iter79.getValue());
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.supportedFeatures != null) {
        oprot.writeFieldBegin(SUPPORTED_FEATURES_FIELD_DESC);
        {
          ...
          for (ServiceFeature _iter80 : struct.supportedFeatures)
          {
      ...
      if (struct.featuresWithParams != null) {
        oprot.writeFieldBegin(FEATURES_WITH_PARAMS_FIELD_DESC);
        {
          ...
          for (Map.Entry<ServiceFeatureParameterized, List<Integer>> _iter81 : struct.featuresWithParams.entrySet())
          {
            oprot.writeI32(_iter81.getKey().getValue());
            {
              oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I32, _iter81.getValue().size()));
              for (int _iter82 : _iter81.getValue())
              {
  ...
  private static class ServiceMetaDataTupleScheme extends TupleScheme<ServiceMetaData> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ServiceMetaData struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.identifierQuote);
      {
        ...
        for (String _iter83 : struct.sqlKeywords)
        {
      ...
      }
      {
        ...
        for (String _iter84 : struct.numericFunctions)
        {
      ...
      }
      {
        ...
        for (String _iter85 : struct.stringFunctions)
        {
      ...
      }
      {
        ...
        for (String _iter86 : struct.systemFunctions)
        {
      ...
      }
      {
        ...
        for (String _iter87 : struct.dateTimeFunctions)
        {
      ...
      oprot.writeString(struct.searchStringEscape);
      {
        ...
        for (Map.Entry<SnappyType, Set<SnappyType>> _iter88 : struct.supportedCONVERT.entrySet())
        {
          oprot.writeI32(_iter88.getKey().getValue());
          {
            oprot.writeI32(_iter88.getValue().size());
            for (SnappyType _iter89 : _iter88.getValue())
            {
      ...
      oprot.writeBool(struct.catalogAtStart);
      {
        ...
        for (Map.Entry<TransactionAttribute, Boolean> _iter90 : struct.transactionDefaults.entrySet())
        {
          oprot.writeI32(_iter90.getKey().getValue());
          oprot.writeBool(_iter90.getValue());
        }
      }
      oprot.writeI32(struct.rowIdLifeTime.getValue());
      {
        oprot.writeI32(struct.supportedFeatures.size());
        for (ServiceFeature _iter91 : struct.supportedFeatures)
        {
      ...
      }
      {
        ...
        for (Map.Entry<ServiceFeatureParameterized, List<Integer>> _iter92 : struct.featuresWithParams.entrySet())
        {
          oprot.writeI32(_iter92.getKey().getValue());
          {
            oprot.writeI32(_iter92.getValue().size());
            for (int _iter93 : _iter92.getValue())
            {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ServiceMetaData struct) throws org.apache.thrift.TException {
      ...
      struct.setIdentifierQuoteIsSet(true);
      {
        ...
        struct.sqlKeywords = new ArrayList<String>(_list94.size);
        String _elem95;
        for (int _i96 = 0; _i96 < _list94.size; ++_i96)
        {
          _elem95 = iprot.readString();
          struct.sqlKeywords.add(_elem95);
        }
      }
      struct.setSqlKeywordsIsSet(true);
      {
        ...
        struct.numericFunctions = new ArrayList<String>(_list97.size);
        String _elem98;
        for (int _i99 = 0; _i99 < _list97.size; ++_i99)
        {
          _elem98 = iprot.readString();
          struct.numericFunctions.add(_elem98);
        }
      }
      struct.setNumericFunctionsIsSet(true);
      {
        ...
        struct.stringFunctions = new ArrayList<String>(_list100.size);
        String _elem101;
        for (int _i102 = 0; _i102 < _list100.size; ++_i102)
        {
          _elem101 = iprot.readString();
          struct.stringFunctions.add(_elem101);
        }
      }
      struct.setStringFunctionsIsSet(true);
      {
        ...
        struct.systemFunctions = new ArrayList<String>(_list103.size);
        String _elem104;
        for (int _i105 = 0; _i105 < _list103.size; ++_i105)
        {
          _elem104 = iprot.readString();
          struct.systemFunctions.add(_elem104);
        }
      }
      struct.setSystemFunctionsIsSet(true);
      {
        ...
        struct.dateTimeFunctions = new ArrayList<String>(_list106.size);
        String _elem107;
        for (int _i108 = 0; _i108 < _list106.size; ++_i108)
        {
          _elem107 = iprot.readString();
          struct.dateTimeFunctions.add(_elem107);
        }
      }
      struct.setDateTimeFunctionsIsSet(true);
      struct.searchStringEscape = iprot.readString();
      struct.setSearchStringEscapeIsSet(true);
      {
        org.apache.thrift.protocol.TMap _map109 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.SET, iprot.readI32());
        struct.supportedCONVERT = new HashMap<SnappyType,Set<SnappyType>>(2*_map109.size);
        SnappyType _key110;
        Set<SnappyType> _val111;
        for (int _i112 = 0; _i112 < _map109.size; ++_i112)
        {
          _key110 = io.snappydata.thrift.SnappyType.findByValue(iprot.readI32());
          {
            ...
            _val111 = new HashSet<SnappyType>(2*_set113.size);
            SnappyType _elem114;
            for (int _i115 = 0; _i115 < _set113.size; ++_i115)
            {
              _elem114 = io.snappydata.thrift.SnappyType.findByValue(iprot.readI32());
              _val111.add(_elem114);
            }
          }
          struct.supportedCONVERT.put(_key110, _val111);
        }
      }
      struct.setSupportedCONVERTIsSet(true);
      struct.schemaTerm = iprot.readString();
      ...
      struct.setCatalogAtStartIsSet(true);
      {
        org.apache.thrift.protocol.TMap _map116 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.BOOL, iprot.readI32());
        struct.transactionDefaults = new HashMap<TransactionAttribute,Boolean>(2*_map116.size);
        TransactionAttribute _key117;
        boolean _val118;
        for (int _i119 = 0; _i119 < _map116.size; ++_i119)
        {
          _key117 = io.snappydata.thrift.TransactionAttribute.findByValue(iprot.readI32());
          _val118 = iprot.readBool();
          struct.transactionDefaults.put(_key117, _val118);
        }
      }
      struct.setTransactionDefaultsIsSet(true);
      struct.rowIdLifeTime = io.snappydata.thrift.RowIdLifetime.findByValue(iprot.readI32());
      struct.setRowIdLifeTimeIsSet(true);
      {
        org.apache.thrift.protocol.TSet _set120 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, iprot.readI32());
        struct.supportedFeatures = new HashSet<ServiceFeature>(2*_set120.size);
        ServiceFeature _elem121;
        for (int _i122 = 0; _i122 < _set120.size; ++_i122)
        {
          _elem121 = io.snappydata.thrift.ServiceFeature.findByValue(iprot.readI32());
          struct.supportedFeatures.add(_elem121);
        }
      }
      struct.setSupportedFeaturesIsSet(true);
      {
        org.apache.thrift.protocol.TMap _map123 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.LIST, iprot.readI32());
        struct.featuresWithParams = new HashMap<ServiceFeatureParameterized,List<Integer>>(2*_map123.size);
        ServiceFeatureParameterized _key124;
        List<Integer> _val125;
        for (int _i126 = 0; _i126 < _map123.size; ++_i126)
        {
          _key124 = io.snappydata.thrift.ServiceFeatureParameterized.findByValue(iprot.readI32());
          {
            ...
            _val125 = new ArrayList<Integer>(_list127.size);
            int _elem128;
          ...
          struct.featuresWithParams.put(_key124, _val125);
        }
      }
      struct.setFeaturesWithParamsIsSet(true);
