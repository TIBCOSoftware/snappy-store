...
public class ServiceMetaDataArgs implements org.apache.thrift.TBase<ServiceMetaDataArgs, ServiceMetaDataArgs._Fields>, java.io.Serializable, Cloneable, Comparable<ServiceMetaDataArgs> {
  ...
  private static final org.apache.thrift.protocol.TField CONN_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("connId", org.apache.thrift.protocol.TType.I32, (short)1);
  ...
  private static final _Fields optionals[] = {_Fields.TOKEN,_Fields.SCHEMA,_Fields.TABLE,_Fields.TABLE_TYPES,_Fields.COLUMN_NAME,_Fields.FOREIGN_SCHEMA,_Fields.FOREIGN_TABLE,_Fields.PROCEDURE_NAME,_Fields.FUNCTION_NAME,_Fields.ATTRIBUTE_NAME,_Fields.TYPE_NAME,_Fields.TYPE_ID};
  ...
  public ServiceMetaDataArgs setConnId(int connId) {
    this.connId = connId;
    setConnIdIsSet(true);
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tableTypes = new ArrayList<String>(_list130.size);
                String _elem131;
                for (int _i132 = 0; _i132 < _list130.size; ++_i132)
                {
                  _elem131 = iprot.readString();
                  struct.tableTypes.add(_elem131);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.tableTypes != null) {
        if (struct.isSetTableTypes()) {
          oprot.writeFieldBegin(TABLE_TYPES_FIELD_DESC);
          {
            ...
            for (String _iter133 : struct.tableTypes)
            {
      ...
      if (struct.isSetTableTypes()) {
        {
          ...
          for (String _iter134 : struct.tableTypes)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.tableTypes = new ArrayList<String>(_list135.size);
          String _elem136;
          for (int _i137 = 0; _i137 < _list135.size; ++_i137)
          {
            _elem136 = iprot.readString();
            struct.tableTypes.add(_elem136);
          }
        }
        struct.setTableTypesIsSet(true);
      }
