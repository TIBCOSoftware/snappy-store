            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.rows = new ArrayList<Row>(_list188.size);
                Row _elem189;
                for (int _i190 = 0; _i190 < _list188.size; ++_i190)
                {
                  _elem189 = new Row();
                  _elem189.read(iprot);
                  struct.rows.add(_elem189);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.metadata = new ArrayList<ColumnDescriptor>(_list191.size);
                ColumnDescriptor _elem192;
                for (int _i193 = 0; _i193 < _list191.size; ++_i193)
                {
                  _elem192 = new ColumnDescriptor();
                  _elem192.read(iprot);
                  struct.metadata.add(_elem192);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.rowIdsForUpdateOrDelete = new ArrayList<Long>(_list194.size);
                long _elem195;
                for (int _i196 = 0; _i196 < _list194.size; ++_i196)
                {
                  _elem195 = iprot.readI64();
                  struct.rowIdsForUpdateOrDelete.add(_elem195);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.metadata != null) {
        if (struct.isSetMetadata()) {
          oprot.writeFieldBegin(METADATA_FIELD_DESC);
          {
            ...
            for (ColumnDescriptor _iter198 : struct.metadata)
            {
      ...
      if (struct.rowIdsForUpdateOrDelete != null) {
        if (struct.isSetRowIdsForUpdateOrDelete()) {
          oprot.writeFieldBegin(ROW_IDS_FOR_UPDATE_OR_DELETE_FIELD_DESC);
          {
            ...
            for (long _iter199 : struct.rowIdsForUpdateOrDelete)
            {
  ...
  private static class RowSetTupleScheme extends TupleScheme<RowSet> {
      ...
      if (struct.isSetMetadata()) {
        {
          ...
          for (ColumnDescriptor _iter201 : struct.metadata)
          {
      ...
      if (struct.isSetRowIdsForUpdateOrDelete()) {
        {
          ...
          for (long _iter202 : struct.rowIdsForUpdateOrDelete)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, RowSet struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.rows = new ArrayList<Row>(_list203.size);
        Row _elem204;
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.metadata = new ArrayList<ColumnDescriptor>(_list206.size);
          ColumnDescriptor _elem207;
          for (int _i208 = 0; _i208 < _list206.size; ++_i208)
          {
            _elem207 = new ColumnDescriptor();
            _elem207.read(iprot);
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.rowIdsForUpdateOrDelete = new ArrayList<Long>(_list209.size);
          long _elem210;
          for (int _i211 = 0; _i211 < _list209.size; ++_i211)
          {
            _elem210 = iprot.readI64();
            struct.rowIdsForUpdateOrDelete.add(_elem210);
          }
        }
        struct.setRowIdsForUpdateOrDeleteIsSet(true);
      }
