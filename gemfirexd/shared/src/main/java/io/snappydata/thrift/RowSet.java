...
public class RowSet implements org.apache.thrift.TBase<RowSet, RowSet._Fields>, java.io.Serializable, Cloneable, Comparable<RowSet> {
  ...
  private static final org.apache.thrift.protocol.TField STATEMENT_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("statementId", org.apache.thrift.protocol.TType.I32, (short)4);
  private static final org.apache.thrift.protocol.TField CONN_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("connId", org.apache.thrift.protocol.TType.I32, (short)5);
  ...
  public RowSet setCursorId(int cursorId) {
    this.cursorId = cursorId;
    setCursorIdIsSet(true);
    return this;
  }
  ...
  public RowSet setStatementId(int statementId) {
    this.statementId = statementId;
    setStatementIdIsSet(true);
    return this;
  }
  ...
  public RowSet setConnId(int connId) {
    this.connId = connId;
    setConnIdIsSet(true);
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.rows = new ArrayList<Row>(_list224.size);
                Row _elem225;
                for (int _i226 = 0; _i226 < _list224.size; ++_i226)
                {
                  _elem225 = new Row();
                  _elem225.read(iprot);
                  struct.rows.add(_elem225);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.metadata = new ArrayList<ColumnDescriptor>(_list227.size);
                ColumnDescriptor _elem228;
                for (int _i229 = 0; _i229 < _list227.size; ++_i229)
                {
                  _elem228 = new ColumnDescriptor();
                  _elem228.read(iprot);
                  struct.metadata.add(_elem228);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.rowIdsForUpdateOrDelete = new ArrayList<Long>(_list230.size);
                long _elem231;
                for (int _i232 = 0; _i232 < _list230.size; ++_i232)
                {
                  _elem231 = iprot.readI64();
                  struct.rowIdsForUpdateOrDelete.add(_elem231);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.metadata != null) {
        if (struct.isSetMetadata()) {
          oprot.writeFieldBegin(METADATA_FIELD_DESC);
          {
            ...
            for (ColumnDescriptor _iter234 : struct.metadata)
            {
      ...
      if (struct.rowIdsForUpdateOrDelete != null) {
        if (struct.isSetRowIdsForUpdateOrDelete()) {
          oprot.writeFieldBegin(ROW_IDS_FOR_UPDATE_OR_DELETE_FIELD_DESC);
          {
            ...
            for (long _iter235 : struct.rowIdsForUpdateOrDelete)
            {
  ...
  private static class RowSetTupleScheme extends TupleScheme<RowSet> {
      ...
      if (struct.isSetMetadata()) {
        {
          ...
          for (ColumnDescriptor _iter237 : struct.metadata)
          {
      ...
      if (struct.isSetRowIdsForUpdateOrDelete()) {
        {
          ...
          for (long _iter238 : struct.rowIdsForUpdateOrDelete)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, RowSet struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.rows = new ArrayList<Row>(_list239.size);
        Row _elem240;
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.metadata = new ArrayList<ColumnDescriptor>(_list242.size);
          ColumnDescriptor _elem243;
          for (int _i244 = 0; _i244 < _list242.size; ++_i244)
          {
            _elem243 = new ColumnDescriptor();
            _elem243.read(iprot);
            struct.metadata.add(_elem243);
          }
        }
        struct.setMetadataIsSet(true);
      }
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.rowIdsForUpdateOrDelete = new ArrayList<Long>(_list245.size);
          long _elem246;
          for (int _i247 = 0; _i247 < _list245.size; ++_i247)
          {
            _elem246 = iprot.readI64();
            struct.rowIdsForUpdateOrDelete.add(_elem246);
          }
        }
        struct.setRowIdsForUpdateOrDeleteIsSet(true);
      }
