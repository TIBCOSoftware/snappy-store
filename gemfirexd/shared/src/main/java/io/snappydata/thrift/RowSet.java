            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.rows = new ArrayList<Row>(_list196.size);
                Row _elem197;
                for (int _i198 = 0; _i198 < _list196.size; ++_i198)
                {
                  _elem197 = new Row();
                  _elem197.read(iprot);
                  struct.rows.add(_elem197);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.metadata = new ArrayList<ColumnDescriptor>(_list199.size);
                ColumnDescriptor _elem200;
                for (int _i201 = 0; _i201 < _list199.size; ++_i201)
                {
                  _elem200 = new ColumnDescriptor();
                  _elem200.read(iprot);
                  struct.metadata.add(_elem200);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.rowIdsForUpdateOrDelete = new ArrayList<Long>(_list202.size);
                long _elem203;
                for (int _i204 = 0; _i204 < _list202.size; ++_i204)
                {
                  _elem203 = iprot.readI64();
                  struct.rowIdsForUpdateOrDelete.add(_elem203);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.metadata != null) {
        if (struct.isSetMetadata()) {
          oprot.writeFieldBegin(METADATA_FIELD_DESC);
          {
            ...
            for (ColumnDescriptor _iter206 : struct.metadata)
            {
      ...
      if (struct.rowIdsForUpdateOrDelete != null) {
        if (struct.isSetRowIdsForUpdateOrDelete()) {
          oprot.writeFieldBegin(ROW_IDS_FOR_UPDATE_OR_DELETE_FIELD_DESC);
          {
            ...
            for (long _iter207 : struct.rowIdsForUpdateOrDelete)
            {
  ...
  private static class RowSetTupleScheme extends TupleScheme<RowSet> {
      ...
      if (struct.isSetMetadata()) {
        {
          ...
          for (ColumnDescriptor _iter209 : struct.metadata)
          {
      ...
      if (struct.isSetRowIdsForUpdateOrDelete()) {
        {
          ...
          for (long _iter210 : struct.rowIdsForUpdateOrDelete)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, RowSet struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.rows = new ArrayList<Row>(_list211.size);
        Row _elem212;
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.metadata = new ArrayList<ColumnDescriptor>(_list214.size);
          ColumnDescriptor _elem215;
          for (int _i216 = 0; _i216 < _list214.size; ++_i216)
          {
            _elem215 = new ColumnDescriptor();
            _elem215.read(iprot);
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.rowIdsForUpdateOrDelete = new ArrayList<Long>(_list217.size);
          long _elem218;
          for (int _i219 = 0; _i219 < _list217.size; ++_i219)
          {
            _elem218 = iprot.readI64();
            struct.rowIdsForUpdateOrDelete.add(_elem218);
          }
        }
        struct.setRowIdsForUpdateOrDeleteIsSet(true);
      }
