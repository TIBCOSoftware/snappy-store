...
public class StatementAttrs implements org.apache.thrift.TBase<StatementAttrs, StatementAttrs._Fields>, java.io.Serializable, Cloneable, Comparable<StatementAttrs> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.autoIncColumns = new ArrayList<Integer>(_list120.size);
                int _elem121;
                for (int _i122 = 0; _i122 < _list120.size; ++_i122)
                {
                  _elem121 = iprot.readI32();
                  struct.autoIncColumns.add(_elem121);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.autoIncColumnNames = new ArrayList<String>(_list123.size);
                String _elem124;
                for (int _i125 = 0; _i125 < _list123.size; ++_i125)
                {
                  _elem124 = iprot.readString();
                  struct.autoIncColumnNames.add(_elem124);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.pendingTransactionAttrs = new HashMap<TransactionAttribute,Boolean>(2*_map126.size);
                TransactionAttribute _key127;
                boolean _val128;
                for (int _i129 = 0; _i129 < _map126.size; ++_i129)
                {
                  _key127 = io.snappydata.thrift.TransactionAttribute.findByValue(iprot.readI32());
                  _val128 = iprot.readBool();
                  struct.pendingTransactionAttrs.put(_key127, _val128);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.autoIncColumns != null) {
        if (struct.isSetAutoIncColumns()) {
          oprot.writeFieldBegin(AUTO_INC_COLUMNS_FIELD_DESC);
          {
            ...
            for (int _iter130 : struct.autoIncColumns)
            {
      ...
      if (struct.autoIncColumnNames != null) {
        if (struct.isSetAutoIncColumnNames()) {
          oprot.writeFieldBegin(AUTO_INC_COLUMN_NAMES_FIELD_DESC);
          {
            ...
            for (String _iter131 : struct.autoIncColumnNames)
            {
      ...
      if (struct.pendingTransactionAttrs != null) {
        if (struct.isSetPendingTransactionAttrs()) {
          oprot.writeFieldBegin(PENDING_TRANSACTION_ATTRS_FIELD_DESC);
          {
            ...
            for (Map.Entry<TransactionAttribute, Boolean> _iter132 : struct.pendingTransactionAttrs.entrySet())
            {
              oprot.writeI32(_iter132.getKey().getValue());
              oprot.writeBool(_iter132.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class StatementAttrsTupleScheme extends TupleScheme<StatementAttrs> {
      ...
      if (struct.isSetAutoIncColumns()) {
        {
          ...
          for (int _iter133 : struct.autoIncColumns)
          {
      ...
      if (struct.isSetAutoIncColumnNames()) {
        {
          ...
          for (String _iter134 : struct.autoIncColumnNames)
          {
      ...
      if (struct.isSetPendingTransactionAttrs()) {
        {
          ...
          for (Map.Entry<TransactionAttribute, Boolean> _iter135 : struct.pendingTransactionAttrs.entrySet())
          {
            oprot.writeI32(_iter135.getKey().getValue());
            oprot.writeBool(_iter135.getValue());
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, StatementAttrs struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.autoIncColumns = new ArrayList<Integer>(_list136.size);
          int _elem137;
          for (int _i138 = 0; _i138 < _list136.size; ++_i138)
          {
            _elem137 = iprot.readI32();
            struct.autoIncColumns.add(_elem137);
          }
        }
        struct.setAutoIncColumnsIsSet(true);
      }
      if (incoming.get(5)) {
        {
          ...
          struct.autoIncColumnNames = new ArrayList<String>(_list139.size);
          String _elem140;
          for (int _i141 = 0; _i141 < _list139.size; ++_i141)
          {
            _elem140 = iprot.readString();
            struct.autoIncColumnNames.add(_elem140);
          }
        }
        struct.setAutoIncColumnNamesIsSet(true);
      }
      ...
      if (incoming.get(16)) {
        {
          org.apache.thrift.protocol.TMap _map142 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.BOOL, iprot.readI32());
          struct.pendingTransactionAttrs = new HashMap<TransactionAttribute,Boolean>(2*_map142.size);
          TransactionAttribute _key143;
          boolean _val144;
          for (int _i145 = 0; _i145 < _map142.size; ++_i145)
          {
            _key143 = io.snappydata.thrift.TransactionAttribute.findByValue(iprot.readI32());
            _val144 = iprot.readBool();
            struct.pendingTransactionAttrs.put(_key143, _val144);
          }
        }
        struct.setPendingTransactionAttrsIsSet(true);
      }
