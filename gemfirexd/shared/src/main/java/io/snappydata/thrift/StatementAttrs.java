...
public class StatementAttrs implements org.apache.thrift.TBase<StatementAttrs, StatementAttrs._Fields>, java.io.Serializable, Cloneable, Comparable<StatementAttrs> {
      ...
      if (struct.autoIncColumns != null) {
        if (struct.isSetAutoIncColumns()) {
          oprot.writeFieldBegin(AUTO_INC_COLUMNS_FIELD_DESC);
          {
            ...
            for (int _iter138 : struct.autoIncColumns)
            {
      ...
      if (struct.autoIncColumnNames != null) {
        if (struct.isSetAutoIncColumnNames()) {
          oprot.writeFieldBegin(AUTO_INC_COLUMN_NAMES_FIELD_DESC);
          {
            ...
            for (String _iter139 : struct.autoIncColumnNames)
            {
      ...
      if (struct.pendingTransactionAttrs != null) {
        if (struct.isSetPendingTransactionAttrs()) {
          oprot.writeFieldBegin(PENDING_TRANSACTION_ATTRS_FIELD_DESC);
          {
            ...
            for (Map.Entry<TransactionAttribute, Boolean> _iter140 : struct.pendingTransactionAttrs.entrySet())
            {
              oprot.writeI32(_iter140.getKey().getValue());
              oprot.writeBool(_iter140.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class StatementAttrsTupleScheme extends TupleScheme<StatementAttrs> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, StatementAttrs struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.autoIncColumns = new ArrayList<Integer>(_list144.size);
          int _elem145;
          for (int _i146 = 0; _i146 < _list144.size; ++_i146)
          {
            _elem145 = iprot.readI32();
            struct.autoIncColumns.add(_elem145);
          }
        }
        struct.setAutoIncColumnsIsSet(true);
      }
      if (incoming.get(5)) {
        {
          ...
          struct.autoIncColumnNames = new ArrayList<String>(_list147.size);
          String _elem148;
          for (int _i149 = 0; _i149 < _list147.size; ++_i149)
          {
            _elem148 = iprot.readString();
            struct.autoIncColumnNames.add(_elem148);
          }
        }
        struct.setAutoIncColumnNamesIsSet(true);
      }
      ...
      if (incoming.get(16)) {
        {
          org.apache.thrift.protocol.TMap _map150 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.BOOL, iprot.readI32());
          struct.pendingTransactionAttrs = new HashMap<TransactionAttribute,Boolean>(2*_map150.size);
          TransactionAttribute _key151;
          boolean _val152;
          for (int _i153 = 0; _i153 < _map150.size; ++_i153)
          {
            _key151 = io.snappydata.thrift.TransactionAttribute.findByValue(iprot.readI32());
            _val152 = iprot.readBool();
            struct.pendingTransactionAttrs.put(_key151, _val152);
          }
        }
        struct.setPendingTransactionAttrsIsSet(true);
      }
