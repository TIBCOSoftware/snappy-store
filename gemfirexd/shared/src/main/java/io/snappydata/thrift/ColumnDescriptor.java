            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.elementTypes = new ArrayList<SnappyType>(_list172.size);
                SnappyType _elem173;
                for (int _i174 = 0; _i174 < _list172.size; ++_i174)
                {
                  _elem173 = io.snappydata.thrift.SnappyType.findByValue(iprot.readI32());
                  struct.elementTypes.add(_elem173);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.elementTypes != null) {
        if (struct.isSetElementTypes()) {
          oprot.writeFieldBegin(ELEMENT_TYPES_FIELD_DESC);
          {
            ...
            for (SnappyType _iter175 : struct.elementTypes)
            {
      ...
      if (struct.isSetElementTypes()) {
        {
          ...
          for (SnappyType _iter176 : struct.elementTypes)
          {
      ...
      if (incoming.get(9)) {
        {
          ...
          struct.elementTypes = new ArrayList<SnappyType>(_list177.size);
          SnappyType _elem178;
          for (int _i179 = 0; _i179 < _list177.size; ++_i179)
          {
            _elem178 = io.snappydata.thrift.SnappyType.findByValue(iprot.readI32());
            struct.elementTypes.add(_elem178);
          }
        }
        struct.setElementTypesIsSet(true);
      }
