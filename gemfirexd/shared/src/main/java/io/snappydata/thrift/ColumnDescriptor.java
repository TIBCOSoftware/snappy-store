            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.elementTypes = new ArrayList<SnappyType>(_list208.size);
                SnappyType _elem209;
                for (int _i210 = 0; _i210 < _list208.size; ++_i210)
                {
                  _elem209 = io.snappydata.thrift.SnappyType.findByValue(iprot.readI32());
                  struct.elementTypes.add(_elem209);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.elementTypes != null) {
        if (struct.isSetElementTypes()) {
          oprot.writeFieldBegin(ELEMENT_TYPES_FIELD_DESC);
          {
            ...
            for (SnappyType _iter211 : struct.elementTypes)
            {
      ...
      if (struct.isSetElementTypes()) {
        {
          ...
          for (SnappyType _iter212 : struct.elementTypes)
          {
      ...
      if (incoming.get(9)) {
        {
          ...
          struct.elementTypes = new ArrayList<SnappyType>(_list213.size);
          SnappyType _elem214;
          for (int _i215 = 0; _i215 < _list213.size; ++_i215)
          {
            _elem214 = io.snappydata.thrift.SnappyType.findByValue(iprot.readI32());
            struct.elementTypes.add(_elem214);
          }
        }
        struct.setElementTypesIsSet(true);
      }
