            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.elementTypes = new ArrayList<SnappyType>(_list180.size);
                SnappyType _elem181;
                for (int _i182 = 0; _i182 < _list180.size; ++_i182)
                {
                  _elem181 = io.snappydata.thrift.SnappyType.findByValue(iprot.readI32());
                  struct.elementTypes.add(_elem181);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.elementTypes != null) {
        if (struct.isSetElementTypes()) {
          oprot.writeFieldBegin(ELEMENT_TYPES_FIELD_DESC);
          {
            ...
            for (SnappyType _iter183 : struct.elementTypes)
            {
      ...
      if (struct.isSetElementTypes()) {
        {
          ...
          for (SnappyType _iter184 : struct.elementTypes)
          {
      ...
      if (incoming.get(9)) {
        {
          ...
          struct.elementTypes = new ArrayList<SnappyType>(_list185.size);
          SnappyType _elem186;
          for (int _i187 = 0; _i187 < _list185.size; ++_i187)
          {
            _elem186 = io.snappydata.thrift.SnappyType.findByValue(iprot.readI32());
            struct.elementTypes.add(_elem186);
          }
        }
        struct.setElementTypesIsSet(true);
      }
