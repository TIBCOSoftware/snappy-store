...
public class OpenConnectionArgs implements org.apache.thrift.TBase<OpenConnectionArgs, OpenConnectionArgs._Fields>, java.io.Serializable, Cloneable, Comparable<OpenConnectionArgs> {
  ...
  private static final org.apache.thrift.protocol.TField FOR_XA_FIELD_DESC = new org.apache.thrift.protocol.TField("forXA", org.apache.thrift.protocol.TType.BOOL, (short)4);
  ...
  static {
    ...
    tmpMap.put(_Fields.FOR_XA, new org.apache.thrift.meta_data.FieldMetaData("forXA", org.apache.thrift.TFieldRequirementType.REQUIRED, 
  ...
  public boolean equals(OpenConnectionArgs that) {
    ...
    boolean this_present_forXA = true;
    boolean that_present_forXA = true;
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    // alas, we cannot check 'forXA' because it's a primitive and you chose the non-beans generator.
  ...
  private static class OpenConnectionArgsStandardScheme extends StandardScheme<OpenConnectionArgs> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, OpenConnectionArgs struct) throws org.apache.thrift.TException {
      ...
      if (!struct.isSetForXA()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'forXA' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }
