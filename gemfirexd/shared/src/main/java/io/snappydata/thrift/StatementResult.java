...
public class StatementResult implements org.apache.thrift.TBase<StatementResult, StatementResult._Fields>, java.io.Serializable, Cloneable, Comparable<StatementResult> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.procedureOutParams = new HashMap<Integer,ColumnValue>(2*_map247.size);
                int _key248;
                ColumnValue _val249;
                for (int _i250 = 0; _i250 < _map247.size; ++_i250)
                {
                  _key248 = iprot.readI32();
                  _val249 = new ColumnValue();
                  _val249.read(iprot);
                  struct.procedureOutParams.put(_key248, _val249);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.batchUpdateCounts != null) {
        if (struct.isSetBatchUpdateCounts()) {
          oprot.writeFieldBegin(BATCH_UPDATE_COUNTS_FIELD_DESC);
          {
            ...
            for (int _iter251 : struct.batchUpdateCounts)
            {
      ...
      if (struct.procedureOutParams != null) {
        if (struct.isSetProcedureOutParams()) {
          oprot.writeFieldBegin(PROCEDURE_OUT_PARAMS_FIELD_DESC);
          {
            ...
            for (Map.Entry<Integer, ColumnValue> _iter252 : struct.procedureOutParams.entrySet())
            {
  ...
  private static class StatementResultTupleScheme extends TupleScheme<StatementResult> {
      ...
      if (struct.isSetBatchUpdateCounts()) {
        {
          ...
          for (int _iter253 : struct.batchUpdateCounts)
          {
      ...
      if (struct.isSetProcedureOutParams()) {
        {
          ...
          for (Map.Entry<Integer, ColumnValue> _iter254 : struct.procedureOutParams.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, StatementResult struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.batchUpdateCounts = new ArrayList<Integer>(_list255.size);
          int _elem256;
          for (int _i257 = 0; _i257 < _list255.size; ++_i257)
          {
            _elem256 = iprot.readI32();
            struct.batchUpdateCounts.add(_elem256);
          }
        }
        struct.setBatchUpdateCountsIsSet(true);
      }
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TMap _map258 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.procedureOutParams = new HashMap<Integer,ColumnValue>(2*_map258.size);
          int _key259;
          ColumnValue _val260;
          for (int _i261 = 0; _i261 < _map258.size; ++_i261)
          {
            _key259 = iprot.readI32();
            _val260 = new ColumnValue();
            _val260.read(iprot);
            struct.procedureOutParams.put(_key259, _val260);
          }
        }
        struct.setProcedureOutParamsIsSet(true);
      }
