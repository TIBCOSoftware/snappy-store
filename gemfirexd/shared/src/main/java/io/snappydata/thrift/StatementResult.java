...
public class StatementResult implements org.apache.thrift.TBase<StatementResult, StatementResult._Fields>, java.io.Serializable, Cloneable, Comparable<StatementResult> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.procedureOutParams = new HashMap<Integer,ColumnValue>(2*_map239.size);
                int _key240;
                ColumnValue _val241;
                for (int _i242 = 0; _i242 < _map239.size; ++_i242)
                {
                  _key240 = iprot.readI32();
                  _val241 = new ColumnValue();
                  _val241.read(iprot);
                  struct.procedureOutParams.put(_key240, _val241);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.batchUpdateCounts != null) {
        if (struct.isSetBatchUpdateCounts()) {
          oprot.writeFieldBegin(BATCH_UPDATE_COUNTS_FIELD_DESC);
          {
            ...
            for (int _iter243 : struct.batchUpdateCounts)
            {
      ...
      if (struct.procedureOutParams != null) {
        if (struct.isSetProcedureOutParams()) {
          oprot.writeFieldBegin(PROCEDURE_OUT_PARAMS_FIELD_DESC);
          {
            ...
            for (Map.Entry<Integer, ColumnValue> _iter244 : struct.procedureOutParams.entrySet())
            {
  ...
  private static class StatementResultTupleScheme extends TupleScheme<StatementResult> {
      ...
      if (struct.isSetBatchUpdateCounts()) {
        {
          ...
          for (int _iter245 : struct.batchUpdateCounts)
          {
      ...
      if (struct.isSetProcedureOutParams()) {
        {
          ...
          for (Map.Entry<Integer, ColumnValue> _iter246 : struct.procedureOutParams.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, StatementResult struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.batchUpdateCounts = new ArrayList<Integer>(_list247.size);
          int _elem248;
          for (int _i249 = 0; _i249 < _list247.size; ++_i249)
          {
            _elem248 = iprot.readI32();
            struct.batchUpdateCounts.add(_elem248);
          }
        }
        struct.setBatchUpdateCountsIsSet(true);
      }
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TMap _map250 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.procedureOutParams = new HashMap<Integer,ColumnValue>(2*_map250.size);
          int _key251;
          ColumnValue _val252;
          for (int _i253 = 0; _i253 < _map250.size; ++_i253)
          {
            _key251 = iprot.readI32();
            _val252 = new ColumnValue();
            _val252.read(iprot);
            struct.procedureOutParams.put(_key251, _val252);
          }
        }
        struct.setProcedureOutParamsIsSet(true);
      }
