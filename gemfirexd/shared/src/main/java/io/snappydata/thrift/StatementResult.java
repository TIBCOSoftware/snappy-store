...
public class StatementResult implements org.apache.thrift.TBase<StatementResult, StatementResult._Fields>, java.io.Serializable, Cloneable, Comparable<StatementResult> {
  ...
  private static final org.apache.thrift.protocol.TField PROCEDURE_OUT_PARAMS_FIELD_DESC = new org.apache.thrift.protocol.TField("procedureOutParams", org.apache.thrift.protocol.TType.STRUCT, (short)4);
  ...
  public Row procedureOutParams; // optional
  ...
  public StatementResult(StatementResult other) {
    ...
    if (other.isSetProcedureOutParams()) {
      this.procedureOutParams = new Row(other.procedureOutParams);
    }
  ...
  public Row getProcedureOutParams() {
    return this.procedureOutParams;
  }

  public StatementResult setProcedureOutParams(Row procedureOutParams) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case PROCEDURE_OUT_PARAMS:
      if (value == null) {
        ...
        setProcedureOutParams((Row)value);
      }
      break;
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (procedureOutParams != null) {
      procedureOutParams.validate();
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, StatementResult struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 4: // PROCEDURE_OUT_PARAMS
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.procedureOutParams = new Row();
              struct.procedureOutParams.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, StatementResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.batchUpdateCounts != null) {
        if (struct.isSetBatchUpdateCounts()) {
          oprot.writeFieldBegin(BATCH_UPDATE_COUNTS_FIELD_DESC);
          {
            ...
            for (int _iter275 : struct.batchUpdateCounts)
            {
      ...
      if (struct.procedureOutParams != null) {
        if (struct.isSetProcedureOutParams()) {
          ...
          struct.procedureOutParams.write(oprot);
          oprot.writeFieldEnd();
        }
      }
  ...
  private static class StatementResultTupleScheme extends TupleScheme<StatementResult> {
      ...
      if (struct.isSetBatchUpdateCounts()) {
        {
          ...
          for (int _iter276 : struct.batchUpdateCounts)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, StatementResult struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TList _list277 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.batchUpdateCounts = new ArrayList<Integer>(_list277.size);
          int _elem278;
          for (int _i279 = 0; _i279 < _list277.size; ++_i279)
          {
            _elem278 = iprot.readI32();
            struct.batchUpdateCounts.add(_elem278);
          }
        }
        struct.setBatchUpdateCountsIsSet(true);
      }
