...
public class StatementResult implements org.apache.thrift.TBase<StatementResult, StatementResult._Fields>, java.io.Serializable, Cloneable, Comparable<StatementResult> {
  ...
  private static final org.apache.thrift.protocol.TField WARNINGS_FIELD_DESC = new org.apache.thrift.protocol.TField("warnings", org.apache.thrift.protocol.TType.STRUCT, (short)6);
  private static final org.apache.thrift.protocol.TField PREPARED_RESULT_FIELD_DESC = new org.apache.thrift.protocol.TField("preparedResult", org.apache.thrift.protocol.TType.STRUCT, (short)7);
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    WARNINGS((short)6, "warnings"),
    PREPARED_RESULT((short)7, "preparedResult");
  ...
  private static final _Fields optionals[] = {_Fields.RESULT_SET,_Fields.UPDATE_COUNT,_Fields.BATCH_UPDATE_COUNTS,_Fields.PROCEDURE_OUT_PARAMS,_Fields.GENERATED_KEYS,_Fields.WARNINGS,_Fields.PREPARED_RESULT};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.batchUpdateCounts = new ArrayList<Integer>(_list272.size);
                int _elem273;
                for (int _i274 = 0; _i274 < _list272.size; ++_i274)
                {
                  _elem273 = iprot.readI32();
                  struct.batchUpdateCounts.add(_elem273);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.procedureOutParams = new HashMap<Integer,ColumnValue>(2*_map275.size);
                int _key276;
                ColumnValue _val277;
                for (int _i278 = 0; _i278 < _map275.size; ++_i278)
                {
                  _key276 = iprot.readI32();
                  _val277 = new ColumnValue();
                  _val277.read(iprot);
                  struct.procedureOutParams.put(_key276, _val277);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.batchUpdateCounts != null) {
        if (struct.isSetBatchUpdateCounts()) {
          oprot.writeFieldBegin(BATCH_UPDATE_COUNTS_FIELD_DESC);
          {
            ...
            for (int _iter279 : struct.batchUpdateCounts)
            {
      ...
      if (struct.procedureOutParams != null) {
        if (struct.isSetProcedureOutParams()) {
          oprot.writeFieldBegin(PROCEDURE_OUT_PARAMS_FIELD_DESC);
          {
            ...
            for (Map.Entry<Integer, ColumnValue> _iter280 : struct.procedureOutParams.entrySet())
            {
  ...
  private static class StatementResultTupleScheme extends TupleScheme<StatementResult> {
      ...
      if (struct.isSetBatchUpdateCounts()) {
        {
          ...
          for (int _iter281 : struct.batchUpdateCounts)
          {
      ...
      if (struct.isSetProcedureOutParams()) {
        {
          ...
          for (Map.Entry<Integer, ColumnValue> _iter282 : struct.procedureOutParams.entrySet())
          {
            oprot.writeI32(_iter282.getKey());
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, StatementResult struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TList _list283 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.batchUpdateCounts = new ArrayList<Integer>(_list283.size);
          int _elem284;
          for (int _i285 = 0; _i285 < _list283.size; ++_i285)
          {
            _elem284 = iprot.readI32();
            struct.batchUpdateCounts.add(_elem284);
          }
        }
        struct.setBatchUpdateCountsIsSet(true);
      }
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TMap _map286 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.procedureOutParams = new HashMap<Integer,ColumnValue>(2*_map286.size);
          int _key287;
          ColumnValue _val288;
          for (int _i289 = 0; _i289 < _map286.size; ++_i289)
          {
            _key287 = iprot.readI32();
            _val288 = new ColumnValue();
            _val288.read(iprot);
            struct.procedureOutParams.put(_key287, _val288);
          }
        }
        struct.setProcedureOutParamsIsSet(true);
      }
