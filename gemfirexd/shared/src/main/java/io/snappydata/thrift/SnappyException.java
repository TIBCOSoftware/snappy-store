            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.nextExceptions = new ArrayList<SnappyExceptionData>(_list112.size);
                SnappyExceptionData _elem113;
                for (int _i114 = 0; _i114 < _list112.size; ++_i114)
                {
                  _elem113 = new SnappyExceptionData();
                  _elem113.read(iprot);
                  struct.nextExceptions.add(_elem113);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.nextExceptions != null) {
        if (struct.isSetNextExceptions()) {
          oprot.writeFieldBegin(NEXT_EXCEPTIONS_FIELD_DESC);
          {
            ...
            for (SnappyExceptionData _iter115 : struct.nextExceptions)
            {
      ...
      if (struct.isSetNextExceptions()) {
        {
          ...
          for (SnappyExceptionData _iter116 : struct.nextExceptions)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.nextExceptions = new ArrayList<SnappyExceptionData>(_list117.size);
          SnappyExceptionData _elem118;
          for (int _i119 = 0; _i119 < _list117.size; ++_i119)
          {
            _elem118 = new SnappyExceptionData();
            _elem118.read(iprot);
            struct.nextExceptions.add(_elem118);
          }
        }
        struct.setNextExceptionsIsSet(true);
      }
