            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.nextExceptions = new ArrayList<SnappyExceptionData>(_list148.size);
                SnappyExceptionData _elem149;
                for (int _i150 = 0; _i150 < _list148.size; ++_i150)
                {
                  _elem149 = new SnappyExceptionData();
                  _elem149.read(iprot);
                  struct.nextExceptions.add(_elem149);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.nextExceptions != null) {
        if (struct.isSetNextExceptions()) {
          oprot.writeFieldBegin(NEXT_EXCEPTIONS_FIELD_DESC);
          {
            ...
            for (SnappyExceptionData _iter151 : struct.nextExceptions)
            {
      ...
      if (struct.isSetNextExceptions()) {
        {
          ...
          for (SnappyExceptionData _iter152 : struct.nextExceptions)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.nextExceptions = new ArrayList<SnappyExceptionData>(_list153.size);
          SnappyExceptionData _elem154;
          for (int _i155 = 0; _i155 < _list153.size; ++_i155)
          {
            _elem154 = new SnappyExceptionData();
            _elem154.read(iprot);
            struct.nextExceptions.add(_elem154);
          }
        }
        struct.setNextExceptionsIsSet(true);
      }
