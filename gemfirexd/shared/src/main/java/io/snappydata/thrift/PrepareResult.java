...
public class PrepareResult implements org.apache.thrift.TBase<PrepareResult, PrepareResult._Fields>, java.io.Serializable, Cloneable, Comparable<PrepareResult> {
  ...
  private static final org.apache.thrift.protocol.TField STATEMENT_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("statementId", org.apache.thrift.protocol.TType.I32, (short)1);
  private static final org.apache.thrift.protocol.TField PARAMETER_META_DATA_FIELD_DESC = new org.apache.thrift.protocol.TField("parameterMetaData", org.apache.thrift.protocol.TType.LIST, (short)2);
  private static final org.apache.thrift.protocol.TField RESULT_SET_META_DATA_FIELD_DESC = new org.apache.thrift.protocol.TField("resultSetMetaData", org.apache.thrift.protocol.TType.LIST, (short)3);
  private static final org.apache.thrift.protocol.TField WARNINGS_FIELD_DESC = new org.apache.thrift.protocol.TField("warnings", org.apache.thrift.protocol.TType.STRUCT, (short)4);
  ...
  public int statementId; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    PARAMETER_META_DATA((short)2, "parameterMetaData"),
    RESULT_SET_META_DATA((short)3, "resultSetMetaData"),
    WARNINGS((short)4, "warnings");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        case 1: // STATEMENT_ID
          return STATEMENT_ID;
        case 2: // PARAMETER_META_DATA
          return PARAMETER_META_DATA;
        case 3: // RESULT_SET_META_DATA
  ...
  public PrepareResult setStatementId(int statementId) {
    this.statementId = statementId;
    setStatementIdIsSet(true);
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.parameterMetaData = new ArrayList<ColumnDescriptor>(_list248.size);
                ColumnDescriptor _elem249;
                for (int _i250 = 0; _i250 < _list248.size; ++_i250)
                {
                  _elem249 = new ColumnDescriptor();
                  _elem249.read(iprot);
                  struct.parameterMetaData.add(_elem249);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resultSetMetaData = new ArrayList<ColumnDescriptor>(_list251.size);
                ColumnDescriptor _elem252;
                for (int _i253 = 0; _i253 < _list251.size; ++_i253)
                {
                  _elem252 = new ColumnDescriptor();
                  _elem252.read(iprot);
                  struct.resultSetMetaData.add(_elem252);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PrepareResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.parameterMetaData != null) {
        oprot.writeFieldBegin(PARAMETER_META_DATA_FIELD_DESC);
        {
          ...
          for (ColumnDescriptor _iter254 : struct.parameterMetaData)
          {
      ...
      if (struct.resultSetMetaData != null) {
        if (struct.isSetResultSetMetaData()) {
          oprot.writeFieldBegin(RESULT_SET_META_DATA_FIELD_DESC);
          {
            ...
            for (ColumnDescriptor _iter255 : struct.resultSetMetaData)
            {
  ...
  private static class PrepareResultTupleScheme extends TupleScheme<PrepareResult> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, PrepareResult struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.statementId);
      {
        ...
        for (ColumnDescriptor _iter256 : struct.parameterMetaData)
        {
      ...
      if (struct.isSetResultSetMetaData()) {
        {
          ...
          for (ColumnDescriptor _iter257 : struct.resultSetMetaData)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, PrepareResult struct) throws org.apache.thrift.TException {
      ...
      struct.setStatementIdIsSet(true);
      {
        ...
        struct.parameterMetaData = new ArrayList<ColumnDescriptor>(_list258.size);
        ColumnDescriptor _elem259;
        for (int _i260 = 0; _i260 < _list258.size; ++_i260)
        {
          _elem259 = new ColumnDescriptor();
          _elem259.read(iprot);
          struct.parameterMetaData.add(_elem259);
        }
      }
      struct.setParameterMetaDataIsSet(true);
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.resultSetMetaData = new ArrayList<ColumnDescriptor>(_list261.size);
          ColumnDescriptor _elem262;
          for (int _i263 = 0; _i263 < _list261.size; ++_i263)
          {
            _elem262 = new ColumnDescriptor();
            _elem262.read(iprot);
            struct.resultSetMetaData.add(_elem262);
          }
        }
        struct.setResultSetMetaDataIsSet(true);
      }
