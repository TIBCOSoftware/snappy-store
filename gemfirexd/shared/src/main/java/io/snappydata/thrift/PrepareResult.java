            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.parameterMetaData = new ArrayList<ColumnDescriptor>(_list212.size);
                ColumnDescriptor _elem213;
                for (int _i214 = 0; _i214 < _list212.size; ++_i214)
                {
                  _elem213 = new ColumnDescriptor();
                  _elem213.read(iprot);
                  struct.parameterMetaData.add(_elem213);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resultSetMetaData = new ArrayList<ColumnDescriptor>(_list215.size);
                ColumnDescriptor _elem216;
                for (int _i217 = 0; _i217 < _list215.size; ++_i217)
                {
                  _elem216 = new ColumnDescriptor();
                  _elem216.read(iprot);
                  struct.resultSetMetaData.add(_elem216);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PrepareResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.parameterMetaData != null) {
        oprot.writeFieldBegin(PARAMETER_META_DATA_FIELD_DESC);
        {
          ...
          for (ColumnDescriptor _iter218 : struct.parameterMetaData)
          {
      ...
      if (struct.resultSetMetaData != null) {
        if (struct.isSetResultSetMetaData()) {
          oprot.writeFieldBegin(RESULT_SET_META_DATA_FIELD_DESC);
          {
            ...
            for (ColumnDescriptor _iter219 : struct.resultSetMetaData)
            {
  ...
  private static class PrepareResultTupleScheme extends TupleScheme<PrepareResult> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, PrepareResult struct) throws org.apache.thrift.TException {
      ...
      oprot.writeByte(struct.statementType);
      {
        ...
        for (ColumnDescriptor _iter220 : struct.parameterMetaData)
        {
      ...
      if (struct.isSetResultSetMetaData()) {
        {
          ...
          for (ColumnDescriptor _iter221 : struct.resultSetMetaData)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, PrepareResult struct) throws org.apache.thrift.TException {
      ...
      struct.setStatementTypeIsSet(true);
      {
        ...
        struct.parameterMetaData = new ArrayList<ColumnDescriptor>(_list222.size);
        ColumnDescriptor _elem223;
        for (int _i224 = 0; _i224 < _list222.size; ++_i224)
        {
          _elem223 = new ColumnDescriptor();
          _elem223.read(iprot);
          struct.parameterMetaData.add(_elem223);
        }
      }
      struct.setParameterMetaDataIsSet(true);
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.resultSetMetaData = new ArrayList<ColumnDescriptor>(_list225.size);
          ColumnDescriptor _elem226;
          for (int _i227 = 0; _i227 < _list225.size; ++_i227)
          {
            _elem226 = new ColumnDescriptor();
            _elem226.read(iprot);
            struct.resultSetMetaData.add(_elem226);
          }
        }
        struct.setResultSetMetaDataIsSet(true);
      }
