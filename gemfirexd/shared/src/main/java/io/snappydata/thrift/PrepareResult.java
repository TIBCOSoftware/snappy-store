            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.parameterMetaData = new ArrayList<ColumnDescriptor>(_list220.size);
                ColumnDescriptor _elem221;
                for (int _i222 = 0; _i222 < _list220.size; ++_i222)
                {
                  _elem221 = new ColumnDescriptor();
                  _elem221.read(iprot);
                  struct.parameterMetaData.add(_elem221);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resultSetMetaData = new ArrayList<ColumnDescriptor>(_list223.size);
                ColumnDescriptor _elem224;
                for (int _i225 = 0; _i225 < _list223.size; ++_i225)
                {
                  _elem224 = new ColumnDescriptor();
                  _elem224.read(iprot);
                  struct.resultSetMetaData.add(_elem224);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PrepareResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.parameterMetaData != null) {
        oprot.writeFieldBegin(PARAMETER_META_DATA_FIELD_DESC);
        {
          ...
          for (ColumnDescriptor _iter226 : struct.parameterMetaData)
          {
      ...
      if (struct.resultSetMetaData != null) {
        if (struct.isSetResultSetMetaData()) {
          oprot.writeFieldBegin(RESULT_SET_META_DATA_FIELD_DESC);
          {
            ...
            for (ColumnDescriptor _iter227 : struct.resultSetMetaData)
            {
  ...
  private static class PrepareResultTupleScheme extends TupleScheme<PrepareResult> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, PrepareResult struct) throws org.apache.thrift.TException {
      ...
      oprot.writeByte(struct.statementType);
      {
        ...
        for (ColumnDescriptor _iter228 : struct.parameterMetaData)
        {
      ...
      if (struct.isSetResultSetMetaData()) {
        {
          ...
          for (ColumnDescriptor _iter229 : struct.resultSetMetaData)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, PrepareResult struct) throws org.apache.thrift.TException {
      ...
      struct.setStatementTypeIsSet(true);
      {
        ...
        struct.parameterMetaData = new ArrayList<ColumnDescriptor>(_list230.size);
        ColumnDescriptor _elem231;
        for (int _i232 = 0; _i232 < _list230.size; ++_i232)
        {
          _elem231 = new ColumnDescriptor();
          _elem231.read(iprot);
          struct.parameterMetaData.add(_elem231);
        }
      }
      struct.setParameterMetaDataIsSet(true);
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.resultSetMetaData = new ArrayList<ColumnDescriptor>(_list233.size);
          ColumnDescriptor _elem234;
          for (int _i235 = 0; _i235 < _list233.size; ++_i235)
          {
            _elem234 = new ColumnDescriptor();
            _elem234.read(iprot);
            struct.resultSetMetaData.add(_elem234);
          }
        }
        struct.setResultSetMetaDataIsSet(true);
      }
