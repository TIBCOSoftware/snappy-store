  ...
  public static class getPreferredServer_args implements org.apache.thrift.TBase<getPreferredServer_args, getPreferredServer_args._Fields>, java.io.Serializable, Cloneable, Comparable<getPreferredServer_args>   {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.serverTypes = new HashSet<ServerType>(2*_set262.size);
                  ServerType _elem263;
                  for (int _i264 = 0; _i264 < _set262.size; ++_i264)
                  {
                    _elem263 = io.snappydata.thrift.ServerType.findByValue(iprot.readI32());
                    struct.serverTypes.add(_elem263);
                  }
                  iprot.readSetEnd();
                }
            ...
            case 2: // SERVER_GROUPS
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  org.apache.thrift.protocol.TSet _set265 = iprot.readSetBegin();
                  struct.serverGroups = new HashSet<String>(2*_set265.size);
                  String _elem266;
                  for (int _i267 = 0; _i267 < _set265.size; ++_i267)
                  {
                    _elem266 = iprot.readString();
                    struct.serverGroups.add(_elem266);
                  }
                  iprot.readSetEnd();
                }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.failedServers = new HashSet<HostAddress>(2*_set268.size);
                  HostAddress _elem269;
                  for (int _i270 = 0; _i270 < _set268.size; ++_i270)
                  {
                    _elem269 = new HostAddress();
                    _elem269.read(iprot);
                    struct.failedServers.add(_elem269);
                  }
                  iprot.readSetEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getPreferredServer_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.serverTypes != null) {
          oprot.writeFieldBegin(SERVER_TYPES_FIELD_DESC);
          {
            ...
            for (ServerType _iter271 : struct.serverTypes)
            {
        ...
        if (struct.serverGroups != null) {
          oprot.writeFieldBegin(SERVER_GROUPS_FIELD_DESC);
          {
            ...
            for (String _iter272 : struct.serverGroups)
            {
        ...
        if (struct.failedServers != null) {
          oprot.writeFieldBegin(FAILED_SERVERS_FIELD_DESC);
          {
            ...
            for (HostAddress _iter273 : struct.failedServers)
            {
    ...
    private static class getPreferredServer_argsTupleScheme extends TupleScheme<getPreferredServer_args> {
        ...
        if (struct.isSetServerTypes()) {
          {
            ...
            for (ServerType _iter274 : struct.serverTypes)
            {
        ...
        if (struct.isSetServerGroups()) {
          {
            ...
            for (String _iter275 : struct.serverGroups)
            {
        ...
        if (struct.isSetFailedServers()) {
          {
            ...
            for (HostAddress _iter276 : struct.failedServers)
            {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, getPreferredServer_args struct) throws org.apache.thrift.TException {
        ...
        if (incoming.get(0)) {
          {
            org.apache.thrift.protocol.TSet _set277 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, iprot.readI32());
            struct.serverTypes = new HashSet<ServerType>(2*_set277.size);
            ServerType _elem278;
            for (int _i279 = 0; _i279 < _set277.size; ++_i279)
            {
              _elem278 = io.snappydata.thrift.ServerType.findByValue(iprot.readI32());
              struct.serverTypes.add(_elem278);
            }
          }
          struct.setServerTypesIsSet(true);
        }
        if (incoming.get(1)) {
          {
            ...
            struct.serverGroups = new HashSet<String>(2*_set280.size);
            String _elem281;
            for (int _i282 = 0; _i282 < _set280.size; ++_i282)
            {
              _elem281 = iprot.readString();
              struct.serverGroups.add(_elem281);
            }
          }
          struct.setServerGroupsIsSet(true);
        }
        if (incoming.get(2)) {
          {
            ...
            struct.failedServers = new HashSet<HostAddress>(2*_set283.size);
            HostAddress _elem284;
            for (int _i285 = 0; _i285 < _set283.size; ++_i285)
            {
              _elem284 = new HostAddress();
              _elem284.read(iprot);
              struct.failedServers.add(_elem284);
            }
          }
          struct.setFailedServersIsSet(true);
        }
    ...
    private static class getAllServersWithPreferredServer_argsStandardScheme extends StandardScheme<getAllServersWithPreferredServer_args> {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.serverTypes = new HashSet<ServerType>(2*_set286.size);
                  ServerType _elem287;
                  for (int _i288 = 0; _i288 < _set286.size; ++_i288)
                  {
                    _elem287 = io.snappydata.thrift.ServerType.findByValue(iprot.readI32());
                    struct.serverTypes.add(_elem287);
                  }
                  iprot.readSetEnd();
                }
                struct.setServerTypesIsSet(true);
            ...
            case 2: // SERVER_GROUPS
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  org.apache.thrift.protocol.TSet _set289 = iprot.readSetBegin();
                  struct.serverGroups = new HashSet<String>(2*_set289.size);
                  String _elem290;
                  for (int _i291 = 0; _i291 < _set289.size; ++_i291)
                  {
                    _elem290 = iprot.readString();
                    struct.serverGroups.add(_elem290);
                  }
                  iprot.readSetEnd();
                }
                struct.setServerGroupsIsSet(true);
            ...
            case 3: // FAILED_SERVERS
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  org.apache.thrift.protocol.TSet _set292 = iprot.readSetBegin();
                  struct.failedServers = new HashSet<HostAddress>(2*_set292.size);
                  HostAddress _elem293;
                  for (int _i294 = 0; _i294 < _set292.size; ++_i294)
                  {
                    _elem293 = new HostAddress();
                    _elem293.read(iprot);
                    struct.failedServers.add(_elem293);
                  }
                  iprot.readSetEnd();
                }
                struct.setFailedServersIsSet(true);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getAllServersWithPreferredServer_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.serverTypes != null) {
          ...
          {
            oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, struct.serverTypes.size()));
            for (ServerType _iter295 : struct.serverTypes)
            {
        ...
        if (struct.serverGroups != null) {
          ...
          {
            oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRING, struct.serverGroups.size()));
            for (String _iter296 : struct.serverGroups)
            {
        ...
        if (struct.failedServers != null) {
          ...
          {
            oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRUCT, struct.failedServers.size()));
            for (HostAddress _iter297 : struct.failedServers)
            {
    ...
    private static class getAllServersWithPreferredServer_argsTupleScheme extends TupleScheme<getAllServersWithPreferredServer_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getAllServersWithPreferredServer_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetServerTypes()) {
          {
            oprot.writeI32(struct.serverTypes.size());
            for (ServerType _iter298 : struct.serverTypes)
            {
              oprot.writeI32(_iter298.getValue());
            }
          }
        }
        if (struct.isSetServerGroups()) {
          {
            oprot.writeI32(struct.serverGroups.size());
            for (String _iter299 : struct.serverGroups)
            {
        ...
        if (struct.isSetFailedServers()) {
          {
            oprot.writeI32(struct.failedServers.size());
            for (HostAddress _iter300 : struct.failedServers)
            {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, getAllServersWithPreferredServer_args struct) throws org.apache.thrift.TException {
        ...
        if (incoming.get(0)) {
          {
            org.apache.thrift.protocol.TSet _set301 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, iprot.readI32());
            struct.serverTypes = new HashSet<ServerType>(2*_set301.size);
            ServerType _elem302;
            for (int _i303 = 0; _i303 < _set301.size; ++_i303)
            {
              _elem302 = io.snappydata.thrift.ServerType.findByValue(iprot.readI32());
              struct.serverTypes.add(_elem302);
            }
          }
          struct.setServerTypesIsSet(true);
        }
        if (incoming.get(1)) {
          {
            ...
            struct.serverGroups = new HashSet<String>(2*_set304.size);
            String _elem305;
            for (int _i306 = 0; _i306 < _set304.size; ++_i306)
            {
              _elem305 = iprot.readString();
              struct.serverGroups.add(_elem305);
            }
          }
          struct.setServerGroupsIsSet(true);
        }
        if (incoming.get(2)) {
          {
            ...
            struct.failedServers = new HashSet<HostAddress>(2*_set307.size);
            HostAddress _elem308;
            for (int _i309 = 0; _i309 < _set307.size; ++_i309)
            {
              _elem308 = new HostAddress();
              _elem308.read(iprot);
              struct.failedServers.add(_elem308);
            }
          }
          struct.setFailedServersIsSet(true);
        }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<HostAddress>(_list310.size);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getAllServersWithPreferredServer_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (HostAddress _iter313 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (HostAddress _iter314 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<HostAddress>(_list315.size);
