...
public class LocatorService {
  ...
  public interface Iface {
    ...
    public void closeConnection() throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_closeConnection() throws org.apache.thrift.TException
    {
  ...
  public static class getPreferredServer_args implements org.apache.thrift.TBase<getPreferredServer_args, getPreferredServer_args._Fields>, java.io.Serializable, Cloneable, Comparable<getPreferredServer_args>   {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.serverTypes = new HashSet<ServerType>(2*_set290.size);
                  ServerType _elem291;
                  for (int _i292 = 0; _i292 < _set290.size; ++_i292)
                  {
                    _elem291 = io.snappydata.thrift.ServerType.findByValue(iprot.readI32());
                    struct.serverTypes.add(_elem291);
                  }
                  iprot.readSetEnd();
                }
            ...
            case 2: // SERVER_GROUPS
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  org.apache.thrift.protocol.TSet _set293 = iprot.readSetBegin();
                  struct.serverGroups = new HashSet<String>(2*_set293.size);
                  String _elem294;
                  for (int _i295 = 0; _i295 < _set293.size; ++_i295)
                  {
                    _elem294 = iprot.readString();
                    struct.serverGroups.add(_elem294);
                  }
                  iprot.readSetEnd();
                }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.failedServers = new HashSet<HostAddress>(2*_set296.size);
                  HostAddress _elem297;
                  for (int _i298 = 0; _i298 < _set296.size; ++_i298)
                  {
                    _elem297 = new HostAddress();
                    _elem297.read(iprot);
                    struct.failedServers.add(_elem297);
                  }
                  iprot.readSetEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getPreferredServer_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.serverTypes != null) {
          oprot.writeFieldBegin(SERVER_TYPES_FIELD_DESC);
          {
            ...
            for (ServerType _iter299 : struct.serverTypes)
            {
        ...
        if (struct.serverGroups != null) {
          oprot.writeFieldBegin(SERVER_GROUPS_FIELD_DESC);
          {
            ...
            for (String _iter300 : struct.serverGroups)
            {
        ...
        if (struct.failedServers != null) {
          oprot.writeFieldBegin(FAILED_SERVERS_FIELD_DESC);
          {
            ...
            for (HostAddress _iter301 : struct.failedServers)
            {
    ...
    private static class getPreferredServer_argsTupleScheme extends TupleScheme<getPreferredServer_args> {
        ...
        if (struct.isSetServerTypes()) {
          {
            ...
            for (ServerType _iter302 : struct.serverTypes)
            {
        ...
        if (struct.isSetServerGroups()) {
          {
            ...
            for (String _iter303 : struct.serverGroups)
            {
        ...
        if (struct.isSetFailedServers()) {
          {
            ...
            for (HostAddress _iter304 : struct.failedServers)
            {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, getPreferredServer_args struct) throws org.apache.thrift.TException {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.serverTypes = new HashSet<ServerType>(2*_set305.size);
            ServerType _elem306;
            for (int _i307 = 0; _i307 < _set305.size; ++_i307)
            {
              _elem306 = io.snappydata.thrift.ServerType.findByValue(iprot.readI32());
              struct.serverTypes.add(_elem306);
            }
          }
          struct.setServerTypesIsSet(true);
        }
        if (incoming.get(1)) {
          {
            ...
            struct.serverGroups = new HashSet<String>(2*_set308.size);
            String _elem309;
            for (int _i310 = 0; _i310 < _set308.size; ++_i310)
            {
              _elem309 = iprot.readString();
              struct.serverGroups.add(_elem309);
            }
          }
          struct.setServerGroupsIsSet(true);
        }
        if (incoming.get(2)) {
          {
            org.apache.thrift.protocol.TSet _set311 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
            struct.failedServers = new HashSet<HostAddress>(2*_set311.size);
            HostAddress _elem312;
            for (int _i313 = 0; _i313 < _set311.size; ++_i313)
            {
              _elem312 = new HostAddress();
              _elem312.read(iprot);
              struct.failedServers.add(_elem312);
            }
          }
          struct.setFailedServersIsSet(true);
        }
    ...
    private static class getAllServersWithPreferredServer_argsStandardScheme extends StandardScheme<getAllServersWithPreferredServer_args> {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 1: // SERVER_TYPES
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  org.apache.thrift.protocol.TSet _set314 = iprot.readSetBegin();
                  struct.serverTypes = new HashSet<ServerType>(2*_set314.size);
                  ServerType _elem315;
                  for (int _i316 = 0; _i316 < _set314.size; ++_i316)
                  {
                    _elem315 = io.snappydata.thrift.ServerType.findByValue(iprot.readI32());
                    struct.serverTypes.add(_elem315);
                  }
                  iprot.readSetEnd();
                }
                struct.setServerTypesIsSet(true);
            ...
            case 2: // SERVER_GROUPS
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  org.apache.thrift.protocol.TSet _set317 = iprot.readSetBegin();
                  struct.serverGroups = new HashSet<String>(2*_set317.size);
                  String _elem318;
                  for (int _i319 = 0; _i319 < _set317.size; ++_i319)
                  {
                    _elem318 = iprot.readString();
                    struct.serverGroups.add(_elem318);
                  }
                  iprot.readSetEnd();
                }
                struct.setServerGroupsIsSet(true);
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.failedServers = new HashSet<HostAddress>(2*_set320.size);
                  HostAddress _elem321;
                  for (int _i322 = 0; _i322 < _set320.size; ++_i322)
                  {
                    _elem321 = new HostAddress();
                    _elem321.read(iprot);
                    struct.failedServers.add(_elem321);
                  }
                  iprot.readSetEnd();
                }
                struct.setFailedServersIsSet(true);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getAllServersWithPreferredServer_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.serverTypes != null) {
          ...
          {
            oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, struct.serverTypes.size()));
            for (ServerType _iter323 : struct.serverTypes)
            {
        ...
        if (struct.serverGroups != null) {
          ...
          {
            oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRING, struct.serverGroups.size()));
            for (String _iter324 : struct.serverGroups)
            {
        ...
        if (struct.failedServers != null) {
          ...
          {
            oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRUCT, struct.failedServers.size()));
            for (HostAddress _iter325 : struct.failedServers)
            {
    ...
    private static class getAllServersWithPreferredServer_argsTupleScheme extends TupleScheme<getAllServersWithPreferredServer_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getAllServersWithPreferredServer_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetServerTypes()) {
          {
            oprot.writeI32(struct.serverTypes.size());
            for (ServerType _iter326 : struct.serverTypes)
            {
              oprot.writeI32(_iter326.getValue());
            }
          }
        }
        if (struct.isSetServerGroups()) {
          {
            oprot.writeI32(struct.serverGroups.size());
            for (String _iter327 : struct.serverGroups)
            {
        ...
        if (struct.isSetFailedServers()) {
          {
            oprot.writeI32(struct.failedServers.size());
            for (HostAddress _iter328 : struct.failedServers)
            {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, getAllServersWithPreferredServer_args struct) throws org.apache.thrift.TException {
        ...
        if (incoming.get(0)) {
          {
            org.apache.thrift.protocol.TSet _set329 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, iprot.readI32());
            struct.serverTypes = new HashSet<ServerType>(2*_set329.size);
            ServerType _elem330;
            for (int _i331 = 0; _i331 < _set329.size; ++_i331)
            {
              _elem330 = io.snappydata.thrift.ServerType.findByValue(iprot.readI32());
              struct.serverTypes.add(_elem330);
            }
          }
          struct.setServerTypesIsSet(true);
        }
        if (incoming.get(1)) {
          {
            org.apache.thrift.protocol.TSet _set332 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRING, iprot.readI32());
            struct.serverGroups = new HashSet<String>(2*_set332.size);
            String _elem333;
            for (int _i334 = 0; _i334 < _set332.size; ++_i334)
            {
              _elem333 = iprot.readString();
              struct.serverGroups.add(_elem333);
            }
          }
          struct.setServerGroupsIsSet(true);
        }
        if (incoming.get(2)) {
          {
            org.apache.thrift.protocol.TSet _set335 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
            struct.failedServers = new HashSet<HostAddress>(2*_set335.size);
            HostAddress _elem336;
            for (int _i337 = 0; _i337 < _set335.size; ++_i337)
            {
              _elem336 = new HostAddress();
              _elem336.read(iprot);
              struct.failedServers.add(_elem336);
            }
          }
          struct.setFailedServersIsSet(true);
        }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<HostAddress>(_list338.size);
                  HostAddress _elem339;
                  for (int _i340 = 0; _i340 < _list338.size; ++_i340)
                  {
                    _elem339 = new HostAddress();
                    _elem339.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getAllServersWithPreferredServer_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (HostAddress _iter341 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (HostAddress _iter342 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<HostAddress>(_list343.size);
            HostAddress _elem344;
            for (int _i345 = 0; _i345 < _list343.size; ++_i345)
            {
              _elem344 = new HostAddress();
              _elem344.read(iprot);
