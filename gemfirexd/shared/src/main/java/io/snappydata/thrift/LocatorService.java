  ...
  public static class getPreferredServer_args implements org.apache.thrift.TBase<getPreferredServer_args, getPreferredServer_args._Fields>, java.io.Serializable, Cloneable, Comparable<getPreferredServer_args>   {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.serverTypes = new HashSet<ServerType>(2*_set446.size);
                  ServerType _elem447;
                  for (int _i448 = 0; _i448 < _set446.size; ++_i448)
                  {
                    _elem447 = io.snappydata.thrift.ServerType.findByValue(iprot.readI32());
                    struct.serverTypes.add(_elem447);
                  }
                  iprot.readSetEnd();
                }
            ...
            case 2: // SERVER_GROUPS
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  org.apache.thrift.protocol.TSet _set449 = iprot.readSetBegin();
                  struct.serverGroups = new HashSet<String>(2*_set449.size);
                  String _elem450;
                  for (int _i451 = 0; _i451 < _set449.size; ++_i451)
                  {
                    _elem450 = iprot.readString();
                    struct.serverGroups.add(_elem450);
                  }
                  iprot.readSetEnd();
                }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.failedServers = new HashSet<HostAddress>(2*_set452.size);
                  HostAddress _elem453;
                  for (int _i454 = 0; _i454 < _set452.size; ++_i454)
                  {
                    _elem453 = new HostAddress();
                    _elem453.read(iprot);
                    struct.failedServers.add(_elem453);
                  }
                  iprot.readSetEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getPreferredServer_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.serverTypes != null) {
          oprot.writeFieldBegin(SERVER_TYPES_FIELD_DESC);
          {
            ...
            for (ServerType _iter455 : struct.serverTypes)
            {
        ...
        if (struct.serverGroups != null) {
          oprot.writeFieldBegin(SERVER_GROUPS_FIELD_DESC);
          {
            ...
            for (String _iter456 : struct.serverGroups)
            {
        ...
        if (struct.failedServers != null) {
          oprot.writeFieldBegin(FAILED_SERVERS_FIELD_DESC);
          {
            ...
            for (HostAddress _iter457 : struct.failedServers)
            {
    ...
    private static class getPreferredServer_argsTupleScheme extends TupleScheme<getPreferredServer_args> {
        ...
        if (struct.isSetServerTypes()) {
          {
            ...
            for (ServerType _iter458 : struct.serverTypes)
            {
        ...
        if (struct.isSetServerGroups()) {
          {
            ...
            for (String _iter459 : struct.serverGroups)
            {
        ...
        if (struct.isSetFailedServers()) {
          {
            ...
            for (HostAddress _iter460 : struct.failedServers)
            {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, getPreferredServer_args struct) throws org.apache.thrift.TException {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.serverTypes = new HashSet<ServerType>(2*_set461.size);
            ServerType _elem462;
            for (int _i463 = 0; _i463 < _set461.size; ++_i463)
            {
              _elem462 = io.snappydata.thrift.ServerType.findByValue(iprot.readI32());
              struct.serverTypes.add(_elem462);
            }
          }
          struct.setServerTypesIsSet(true);
        }
        if (incoming.get(1)) {
          {
            org.apache.thrift.protocol.TSet _set464 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRING, iprot.readI32());
            struct.serverGroups = new HashSet<String>(2*_set464.size);
            String _elem465;
            for (int _i466 = 0; _i466 < _set464.size; ++_i466)
            {
              _elem465 = iprot.readString();
              struct.serverGroups.add(_elem465);
            }
          }
          struct.setServerGroupsIsSet(true);
        }
        if (incoming.get(2)) {
          {
            org.apache.thrift.protocol.TSet _set467 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
            struct.failedServers = new HashSet<HostAddress>(2*_set467.size);
            HostAddress _elem468;
            for (int _i469 = 0; _i469 < _set467.size; ++_i469)
            {
              _elem468 = new HostAddress();
              _elem468.read(iprot);
              struct.failedServers.add(_elem468);
            }
          }
          struct.setFailedServersIsSet(true);
        }
    ...
    private static class getAllServersWithPreferredServer_argsStandardScheme extends StandardScheme<getAllServersWithPreferredServer_args> {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 1: // SERVER_TYPES
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  org.apache.thrift.protocol.TSet _set470 = iprot.readSetBegin();
                  struct.serverTypes = new HashSet<ServerType>(2*_set470.size);
                  ServerType _elem471;
                  for (int _i472 = 0; _i472 < _set470.size; ++_i472)
                  {
                    _elem471 = io.snappydata.thrift.ServerType.findByValue(iprot.readI32());
                    struct.serverTypes.add(_elem471);
                  }
                  iprot.readSetEnd();
                }
                struct.setServerTypesIsSet(true);
            ...
            case 2: // SERVER_GROUPS
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  org.apache.thrift.protocol.TSet _set473 = iprot.readSetBegin();
                  struct.serverGroups = new HashSet<String>(2*_set473.size);
                  String _elem474;
                  for (int _i475 = 0; _i475 < _set473.size; ++_i475)
                  {
                    _elem474 = iprot.readString();
                    struct.serverGroups.add(_elem474);
                  }
                  iprot.readSetEnd();
                }
                struct.setServerGroupsIsSet(true);
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.failedServers = new HashSet<HostAddress>(2*_set476.size);
                  HostAddress _elem477;
                  for (int _i478 = 0; _i478 < _set476.size; ++_i478)
                  {
                    _elem477 = new HostAddress();
                    _elem477.read(iprot);
                    struct.failedServers.add(_elem477);
                  }
                  iprot.readSetEnd();
                }
                struct.setFailedServersIsSet(true);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getAllServersWithPreferredServer_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.serverTypes != null) {
          ...
          {
            oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, struct.serverTypes.size()));
            for (ServerType _iter479 : struct.serverTypes)
            {
        ...
        if (struct.serverGroups != null) {
          ...
          {
            oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRING, struct.serverGroups.size()));
            for (String _iter480 : struct.serverGroups)
            {
        ...
        if (struct.failedServers != null) {
          ...
          {
            oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRUCT, struct.failedServers.size()));
            for (HostAddress _iter481 : struct.failedServers)
            {
    ...
    private static class getAllServersWithPreferredServer_argsTupleScheme extends TupleScheme<getAllServersWithPreferredServer_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getAllServersWithPreferredServer_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetServerTypes()) {
          {
            oprot.writeI32(struct.serverTypes.size());
            for (ServerType _iter482 : struct.serverTypes)
            {
        ...
        if (struct.isSetServerGroups()) {
          {
            oprot.writeI32(struct.serverGroups.size());
            for (String _iter483 : struct.serverGroups)
            {
        ...
        if (struct.isSetFailedServers()) {
          {
            oprot.writeI32(struct.failedServers.size());
            for (HostAddress _iter484 : struct.failedServers)
            {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, getAllServersWithPreferredServer_args struct) throws org.apache.thrift.TException {
        ...
        if (incoming.get(0)) {
          {
            org.apache.thrift.protocol.TSet _set485 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, iprot.readI32());
            struct.serverTypes = new HashSet<ServerType>(2*_set485.size);
            ServerType _elem486;
            for (int _i487 = 0; _i487 < _set485.size; ++_i487)
            {
              _elem486 = io.snappydata.thrift.ServerType.findByValue(iprot.readI32());
              struct.serverTypes.add(_elem486);
            }
          }
          struct.setServerTypesIsSet(true);
        }
        if (incoming.get(1)) {
          {
            ...
            struct.serverGroups = new HashSet<String>(2*_set488.size);
            String _elem489;
            for (int _i490 = 0; _i490 < _set488.size; ++_i490)
            {
              _elem489 = iprot.readString();
              struct.serverGroups.add(_elem489);
            }
          }
          struct.setServerGroupsIsSet(true);
        }
        if (incoming.get(2)) {
          {
            org.apache.thrift.protocol.TSet _set491 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
            struct.failedServers = new HashSet<HostAddress>(2*_set491.size);
            HostAddress _elem492;
            for (int _i493 = 0; _i493 < _set491.size; ++_i493)
            {
              _elem492 = new HostAddress();
              _elem492.read(iprot);
              struct.failedServers.add(_elem492);
            }
          }
          struct.setFailedServersIsSet(true);
        }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<HostAddress>(_list494.size);
                  HostAddress _elem495;
                  for (int _i496 = 0; _i496 < _list494.size; ++_i496)
                  {
                    _elem495 = new HostAddress();
                    _elem495.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getAllServersWithPreferredServer_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (HostAddress _iter497 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (HostAddress _iter498 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<HostAddress>(_list499.size);
            HostAddress _elem500;
            for (int _i501 = 0; _i501 < _list499.size; ++_i501)
            {
              _elem500 = new HostAddress();
              _elem500.read(iprot);
