  ...
  public static class getPreferredServer_args implements org.apache.thrift.TBase<getPreferredServer_args, getPreferredServer_args._Fields>, java.io.Serializable, Cloneable, Comparable<getPreferredServer_args>   {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.serverTypes = new HashSet<ServerType>(2*_set254.size);
                  ServerType _elem255;
                  for (int _i256 = 0; _i256 < _set254.size; ++_i256)
                  {
                    _elem255 = io.snappydata.thrift.ServerType.findByValue(iprot.readI32());
                    struct.serverTypes.add(_elem255);
                  }
                  iprot.readSetEnd();
                }
            ...
            case 2: // SERVER_GROUPS
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  org.apache.thrift.protocol.TSet _set257 = iprot.readSetBegin();
                  struct.serverGroups = new HashSet<String>(2*_set257.size);
                  String _elem258;
                  for (int _i259 = 0; _i259 < _set257.size; ++_i259)
                  {
                    _elem258 = iprot.readString();
                    struct.serverGroups.add(_elem258);
                  }
                  iprot.readSetEnd();
                }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.failedServers = new HashSet<HostAddress>(2*_set260.size);
                  HostAddress _elem261;
                  for (int _i262 = 0; _i262 < _set260.size; ++_i262)
                  {
                    _elem261 = new HostAddress();
                    _elem261.read(iprot);
                    struct.failedServers.add(_elem261);
                  }
                  iprot.readSetEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getPreferredServer_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.serverTypes != null) {
          oprot.writeFieldBegin(SERVER_TYPES_FIELD_DESC);
          {
            ...
            for (ServerType _iter263 : struct.serverTypes)
            {
        ...
        if (struct.serverGroups != null) {
          oprot.writeFieldBegin(SERVER_GROUPS_FIELD_DESC);
          {
            ...
            for (String _iter264 : struct.serverGroups)
            {
        ...
        if (struct.failedServers != null) {
          oprot.writeFieldBegin(FAILED_SERVERS_FIELD_DESC);
          {
            ...
            for (HostAddress _iter265 : struct.failedServers)
            {
    ...
    private static class getPreferredServer_argsTupleScheme extends TupleScheme<getPreferredServer_args> {
        ...
        if (struct.isSetServerTypes()) {
          {
            ...
            for (ServerType _iter266 : struct.serverTypes)
            {
        ...
        if (struct.isSetServerGroups()) {
          {
            ...
            for (String _iter267 : struct.serverGroups)
            {
        ...
        if (struct.isSetFailedServers()) {
          {
            ...
            for (HostAddress _iter268 : struct.failedServers)
            {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, getPreferredServer_args struct) throws org.apache.thrift.TException {
        ...
        if (incoming.get(0)) {
          {
            org.apache.thrift.protocol.TSet _set269 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, iprot.readI32());
            struct.serverTypes = new HashSet<ServerType>(2*_set269.size);
            ServerType _elem270;
            for (int _i271 = 0; _i271 < _set269.size; ++_i271)
            {
              _elem270 = io.snappydata.thrift.ServerType.findByValue(iprot.readI32());
              struct.serverTypes.add(_elem270);
            }
          }
          struct.setServerTypesIsSet(true);
        }
        if (incoming.get(1)) {
          {
            org.apache.thrift.protocol.TSet _set272 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRING, iprot.readI32());
            struct.serverGroups = new HashSet<String>(2*_set272.size);
            String _elem273;
            for (int _i274 = 0; _i274 < _set272.size; ++_i274)
            {
              _elem273 = iprot.readString();
              struct.serverGroups.add(_elem273);
            }
          }
          struct.setServerGroupsIsSet(true);
        }
        if (incoming.get(2)) {
          {
            ...
            struct.failedServers = new HashSet<HostAddress>(2*_set275.size);
            HostAddress _elem276;
            for (int _i277 = 0; _i277 < _set275.size; ++_i277)
            {
              _elem276 = new HostAddress();
              _elem276.read(iprot);
              struct.failedServers.add(_elem276);
            }
          }
          struct.setFailedServersIsSet(true);
        }
    ...
    private static class getAllServersWithPreferredServer_argsStandardScheme extends StandardScheme<getAllServersWithPreferredServer_args> {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.serverTypes = new HashSet<ServerType>(2*_set278.size);
                  ServerType _elem279;
                  for (int _i280 = 0; _i280 < _set278.size; ++_i280)
                  {
                    _elem279 = io.snappydata.thrift.ServerType.findByValue(iprot.readI32());
                    struct.serverTypes.add(_elem279);
                  }
                  iprot.readSetEnd();
                }
                struct.setServerTypesIsSet(true);
            ...
            case 2: // SERVER_GROUPS
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  org.apache.thrift.protocol.TSet _set281 = iprot.readSetBegin();
                  struct.serverGroups = new HashSet<String>(2*_set281.size);
                  String _elem282;
                  for (int _i283 = 0; _i283 < _set281.size; ++_i283)
                  {
                    _elem282 = iprot.readString();
                    struct.serverGroups.add(_elem282);
                  }
                  iprot.readSetEnd();
                }
                struct.setServerGroupsIsSet(true);
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.failedServers = new HashSet<HostAddress>(2*_set284.size);
                  HostAddress _elem285;
                  for (int _i286 = 0; _i286 < _set284.size; ++_i286)
                  {
                    _elem285 = new HostAddress();
                    _elem285.read(iprot);
                    struct.failedServers.add(_elem285);
                  }
                  iprot.readSetEnd();
                }
                struct.setFailedServersIsSet(true);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getAllServersWithPreferredServer_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.serverTypes != null) {
          ...
          {
            oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, struct.serverTypes.size()));
            for (ServerType _iter287 : struct.serverTypes)
            {
        ...
        if (struct.serverGroups != null) {
          ...
          {
            oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRING, struct.serverGroups.size()));
            for (String _iter288 : struct.serverGroups)
            {
        ...
        if (struct.failedServers != null) {
          ...
          {
            oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRUCT, struct.failedServers.size()));
            for (HostAddress _iter289 : struct.failedServers)
            {
    ...
    private static class getAllServersWithPreferredServer_argsTupleScheme extends TupleScheme<getAllServersWithPreferredServer_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getAllServersWithPreferredServer_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetServerTypes()) {
          {
            oprot.writeI32(struct.serverTypes.size());
            for (ServerType _iter290 : struct.serverTypes)
            {
        ...
        if (struct.isSetServerGroups()) {
          {
            oprot.writeI32(struct.serverGroups.size());
            for (String _iter291 : struct.serverGroups)
            {
        ...
        if (struct.isSetFailedServers()) {
          {
            oprot.writeI32(struct.failedServers.size());
            for (HostAddress _iter292 : struct.failedServers)
            {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, getAllServersWithPreferredServer_args struct) throws org.apache.thrift.TException {
        ...
        if (incoming.get(0)) {
          {
            org.apache.thrift.protocol.TSet _set293 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, iprot.readI32());
            struct.serverTypes = new HashSet<ServerType>(2*_set293.size);
            ServerType _elem294;
            for (int _i295 = 0; _i295 < _set293.size; ++_i295)
            {
              _elem294 = io.snappydata.thrift.ServerType.findByValue(iprot.readI32());
              struct.serverTypes.add(_elem294);
            }
          }
          struct.setServerTypesIsSet(true);
        }
        if (incoming.get(1)) {
          {
            org.apache.thrift.protocol.TSet _set296 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRING, iprot.readI32());
            struct.serverGroups = new HashSet<String>(2*_set296.size);
            String _elem297;
            for (int _i298 = 0; _i298 < _set296.size; ++_i298)
            {
              _elem297 = iprot.readString();
              struct.serverGroups.add(_elem297);
            }
          }
          struct.setServerGroupsIsSet(true);
        }
        if (incoming.get(2)) {
          {
            ...
            struct.failedServers = new HashSet<HostAddress>(2*_set299.size);
            HostAddress _elem300;
            for (int _i301 = 0; _i301 < _set299.size; ++_i301)
            {
              _elem300 = new HostAddress();
              _elem300.read(iprot);
              struct.failedServers.add(_elem300);
            }
          }
          struct.setFailedServersIsSet(true);
        }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<HostAddress>(_list302.size);
                  HostAddress _elem303;
                  for (int _i304 = 0; _i304 < _list302.size; ++_i304)
                  {
                    _elem303 = new HostAddress();
                    _elem303.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getAllServersWithPreferredServer_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (HostAddress _iter305 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (HostAddress _iter306 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<HostAddress>(_list307.size);
            HostAddress _elem308;
            for (int _i309 = 0; _i309 < _list307.size; ++_i309)
            {
              _elem308 = new HostAddress();
              _elem308.read(iprot);
