            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.batchUpdateCounts = new ArrayList<Integer>(_list264.size);
                int _elem265;
                for (int _i266 = 0; _i266 < _list264.size; ++_i266)
                {
                  _elem265 = iprot.readI32();
                  struct.batchUpdateCounts.add(_elem265);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.batchUpdateCounts != null) {
        if (struct.isSetBatchUpdateCounts()) {
          oprot.writeFieldBegin(BATCH_UPDATE_COUNTS_FIELD_DESC);
          {
            ...
            for (int _iter267 : struct.batchUpdateCounts)
            {
      ...
      if (struct.isSetBatchUpdateCounts()) {
        {
          ...
          for (int _iter268 : struct.batchUpdateCounts)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.batchUpdateCounts = new ArrayList<Integer>(_list269.size);
          int _elem270;
          for (int _i271 = 0; _i271 < _list269.size; ++_i271)
          {
            _elem270 = iprot.readI32();
            struct.batchUpdateCounts.add(_elem270);
          }
        }
        struct.setBatchUpdateCountsIsSet(true);
      }
