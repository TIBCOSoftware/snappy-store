...
public class UpdateResult implements org.apache.thrift.TBase<UpdateResult, UpdateResult._Fields>, java.io.Serializable, Cloneable, Comparable<UpdateResult> {
  ...
  private static final _Fields optionals[] = {_Fields.UPDATE_COUNT,_Fields.BATCH_UPDATE_COUNTS,_Fields.GENERATED_KEYS,_Fields.WARNINGS};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.batchUpdateCounts = new ArrayList<Integer>(_list228.size);
                int _elem229;
                for (int _i230 = 0; _i230 < _list228.size; ++_i230)
                {
                  _elem229 = iprot.readI32();
                  struct.batchUpdateCounts.add(_elem229);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.batchUpdateCounts != null) {
        if (struct.isSetBatchUpdateCounts()) {
          oprot.writeFieldBegin(BATCH_UPDATE_COUNTS_FIELD_DESC);
          {
            ...
            for (int _iter231 : struct.batchUpdateCounts)
            {
  ...
  private static class UpdateResultTupleScheme extends TupleScheme<UpdateResult> {
      ...
      if (struct.isSetBatchUpdateCounts()) {
        {
          ...
          for (int _iter232 : struct.batchUpdateCounts)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, UpdateResult struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TList _list233 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.batchUpdateCounts = new ArrayList<Integer>(_list233.size);
          int _elem234;
          for (int _i235 = 0; _i235 < _list233.size; ++_i235)
          {
            _elem234 = iprot.readI32();
            struct.batchUpdateCounts.add(_elem234);
          }
        }
        struct.setBatchUpdateCountsIsSet(true);
      }
