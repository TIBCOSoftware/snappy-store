/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.shared.common.reference.SQLState
...
/**
	...
	<LI>Language
	  <UL>
		...
		<LI> 43X00-43Yxx  for com.pivotal.gemfirexd.internal.impl.sql.execute.rts
		<LI> 44X00  for all other com.pivotal.gemfirexd.internal.catalog.types
...
public interface SQLState {
	...
	*/
	...
	// GemStone changes BEGIN
        String JDBC_DRIVER_ALREADY_REGISTER                                     = "XBM0O.D";
        String SUSPECT_UPDATE_DURING_STARTUP                                     = "XBM09.D";
	...
	*/
	...
	String STORE_RTS_NUM_ROW_COMPARISONS = "XSAJK.U";
  ...
  String DATA_INDEX_MAINTENANCE_EXCEPTION                     = "XSDAO.S";
...
// GemStone changes BEGIN
	String LANG_INDEX_DROPPED                                          = "01506";
	String LANG_NO_LOCAL_GATEWAYSENDER_ASYNCEVENTLISTENER              = "01507"; 
	String LANG_ASYNCEVENTLISTENER_ALREADY_RUNNING                        = "01508";
        String LANG_INNER_QUERY_TIMEOUT_MORE_THAN_PARENT_TIMEOUT           = "01509";
        String HDFS_REGION_NOT_PERSISTENT                                  = "0150A";
// GemStone changes END
	...
	*/
	...
	String LANG_INVALID_JSON                                           = "22029";
...
// GemStone changes BEGIN
	String LANG_NO_SUBQUERIES_IN_WHERE_CLAUSE                          = "42904";
// GemStone changes END
	...
	// GemStone changes BEGIN
	//(original code) 42X67 
        String LANG_INVALID_SIZER_HINT_SPEC                                = "42X67";
        // GemStone changes END
...
//	String LANG_INVALID_FORCED_INDEX4                                  = "42Y51";
	...
	String LANG_NO_BULK_INSERT_REPLACE_WITH_TRIGGER                    = "42Z08";
        String LANG_NO_NON_CONSTANT_PARAMETER_ALLOWED                      = "42Z09";
        String LANG_ONLY_ONE_VALUE_LIST_ALLOWED                            = "42Z10";
        String LANG_NO_VALUE_LIST_SUPPLIED                                 = "42Z11";
	...
	String LANG_AI_INVALID_TYPE_WITH_GATEWAYSENDER                                                 = "42Z28";
	
	String LANG_ADDING_GATEWAYSENDER_ON_INT_IDENTITY_COLUMN                                        ="42Z29";
	...
	// com.pivotal.gemfirexd.internal.impl.sql.execute.rts
...
// GemStone changes BEGIN
    String LANG_INVALID_TABLE_TYPE_DEFINITION = "X0Y90.S";
    String LANG_INVALID_COLOCATION_DIFFERENT_COL_COUNT = "X0Y91.S";
    String LANG_INVALID_COLOCATION_COL_TYPES_MISMATCH = "X0Y92.S";
    String LANG_INVALID_COLOCATION_DIFFERENT_GROUPS = "X0Y93.S";
    String LANG_INVALID_COLOCATION_REDUNDANCY_OR_BUCKETS_MISMATCH = "X0Y94.S";
    String LANG_INVALID_COLOCATION_PARTITIONINGPOLICY_MISMATCH = "X0Y95.S";
    String LANG_INVALID_COLOCATION = "X0Y96.S";
    String LANG_INVALID_PARTITIONING_NO_PK = "X0Y97.S";
    String COLOCATED_CHILDREN_EXIST = "X0Y98.S";
    String LANG_INVALID_REFERENCE = "X0Y99.S";

    // used by GemFireXD to signal a node going down during ResultSet
    // iteration (see bug #41471)
    String GFXD_NODE_SHUTDOWN_PREFIX = "X0Z01";
    String GFXD_NODE_SHUTDOWN = GFXD_NODE_SHUTDOWN_PREFIX + ".S";
    String GFXD_OPERATION_CONFLICT_PREFIX = "X0Z02";
    String GFXD_OPERATION_CONFLICT = GFXD_OPERATION_CONFLICT_PREFIX + ".T";
    String GFXD_TRANSACTION_READ_ONLY_PREFIX = "X0Z03";
    String GFXD_TRANSACTION_READ_ONLY = GFXD_TRANSACTION_READ_ONLY_PREFIX + ".T";
    String LANG_INVALID_MEMBER_REFERENCE = "X0Z04.S";
    String GFXD_TRANSACTION_INDOUBT_PREFIX = "X0Z06";
    String GFXD_TRANSACTION_INDOUBT = GFXD_TRANSACTION_INDOUBT_PREFIX + ".T";
    String DISK_STORE_ABSENT = "X0Z07.S";
    String NO_DATASTORE_FOUND = "X0Z08.S";
    String INSUFFICIENT_DATASTORE = "X0Z09.S";
    String ROWLOADER_INVALID_COLUMN_ARRAY_LENGTH = "X0Z10.S";
    String AUTOINCREMENT_GIVEN_START_NOT_SUPPORTED = "X0Z11.S";
    String AUTOINCREMENT_GIVEN_INCREMENT_NOT_SUPPORTED = "X0Z12.S";
    String GENERATED_KEY_OVERFLOW = "X0Z13.S";
    String DD_NOT_PERSISTING = "X0Z14.D";
    String TABLE_NOT_PARTITIONED = "X0Z15.S";
    String GFXD_TRANSACTION_ILLEGAL_PREFIX = "X0Z16";
    String GFXD_TRANSACTION_ILLEGAL = GFXD_TRANSACTION_ILLEGAL_PREFIX + ".T";
    String DAP_RESULT_PROCESSOR_INTERFACE_MISSING = "X0Z17.S";
    String GFXD_NODE_BUCKET_MOVED_PREFIX = "X0Z18";
    String GFXD_NODE_BUCKET_MOVED = GFXD_NODE_BUCKET_MOVED_PREFIX + ".S";
    String DISKSTORE_DUPLICATE_DIR_FOUND = "X0Z19.S";
    String GFXD_PRIMARY_NOT_PRESENT_FOR_BUCKET = "X0Z20.S";
    String SERVER_GROUP_ABSENT_FOR_ASYNC_LISTENER = "X0Z21.S";
    String UNEXPECTED_EXCEPTION_FOR_ASYNC_LISTENER = "X0Z22.S";
    String NO_GATEWAYSENDER_ASYNCEVENTLISTENER_FOUND = "X0Z23.S";
    String UNEXPECTED_EXCEPTION_FOR_WRITER ="X0Z24.S";
    String UNEXPECTED_EXCEPTION_FOR_LISTENER ="X0Z25.S";
    String UNEXPECTED_EXCEPTION_FOR_LOADER ="X0Z26.S";
    String GENERIC_PROC_EXCEPTION ="X0Z27.S";
    String UNEXPECTED_EXCEPTION_FOR_CONFLICT_RESOLVER = "X0Z28.S";
    String CUSTOM_EVICTION_NOT_SET_FOR_TABLE = "X0Z29.S";
    String HDFS_ERROR = "X0Z30.S";
    String UNEXPECTED_EXCEPTION_FOR_EVENT_ERROR_HANDLER = "X0Z31.S";
...
// GemStone changes BEGIN
	String LANG_STATEMENT_NEEDS_RECOMPILE_STATE                        = "XCL32";
	String LANG_STATEMENT_NEEDS_RECOMPILE                              = LANG_STATEMENT_NEEDS_RECOMPILE_STATE + ".S";
	String LANG_STATEMENT_NEEDS_RECOMPILE_PARENT                       = "XCL55.S";
	/* (original code)
...
// GemStone changes END
    ...
    String LANG_STATEMENT_CANCELLED_ON_TIME_OUT                       = "XCL52.S";
...
// GemStone changes BEGIN
    String COLOCATION_NOT_DEFINED = "0A000.S.8";
    String NOT_COLOCATED_WITH = "0A000.S.9";
    String COLOCATION_CRITERIA_UNSATISFIED = "0A000.S.10";
    String NOT_COINCIDING_DATASTORES = "0A000.S.11";
    String UNSUPPORTED_DELETE_RULE = "0A000.S.12";
    String OVERFLOW_TO_DISK_UNSUPPORTED = "0A000.S.13";
    String REPLICATED_PR_CORRELATED_UNSUPPORTED = "0A000.S.14";
    String MEMBER_NOT_FOUND = "0A000.S.15";
    String CORRELATED_NON_PK_SUBQUERY_HAVING_PR_NOT_SUPPORTED = "0A000.S.16";
    String MORE_THAN_ONE_LEVEL_NESTING_NOT_SUPPORTED = "0A000.S.17";
    String SELECT_FOR_UPDATE_WITHOUT_TRANSACTION_NOT_SUPPORTED = "0A000.S.18";
    String SCROLL_NOT_SUPPORTED = "0A000.S.19";
    String SUBQUERY_MORE_THAN_1_NESTING_NOT_SUPPORTED = "0A000.S.20";
    String LANG_AI_GENERATED_BY_DEFAULT_NOT_IMPLEMENTED = "0A000.S.21";
    String UPDATABLE_SCROLL_INSENSITIVE_NOT_SUPPORTED = "0A000.S.22";
    String INTERNAL_SKIP_ORLIST_OPTIMIZATION = "0A000.S.23";
    String INDEX_CASE_INSENSITIVITY_NOT_SUPPORTED = "0A000.S.24";
    String LANG_ALTER_TABLE_ADD_FK_CONSTRAINT_CHECK_FAIL = "0A000.S.25";
    String AUTH_CANNOT_CHANGE_OLD_PASSWORD_FOR_NON_BUILTIN = "0A000.S.26";
    String INDEX_ON_HDFS_DATA_NOT_SUPPORTED_WITH_EVICTION = "0A000.S.27";
    String LRU_EVICTION_NOT_SUPPORTED_FOR_HDFS_TABLE = "0A000.S.28";
    String HDFS_STORE_NOT_SUPPORTED_FOR_REPLICATE_TABLE = "0A000.S.29";
    String FOREIGN_KEY_CONSTRAINT_NOT_SUPPORTED_WITH_EVICTION = "0A000.S.30";
    String HDFS_COMPACTION_NOT_SUPPORTED = "0A000.S.31";
...
// GemStone changes BEGIN
	String AUTH_CANNOT_OVERWRITE_USER_DEFINTION                        = "28503";
	String AUTH_USER_ALREADY_DEFINED                                   = "28504";
// GemStone changes END
    ...
    */
    ...
    String SNAPPY_TX_DISALLOWED_WITH_ROUTE_QUERY_DISABLED = "XJ218.S";
    String SNAPPY_TX_DISALLOWED_ON_COLUMN_TABLES = "XJ219.S";
...
// GemStone changes BEGIN
    String AUTH_INVALID_OLD_PASSWORD                        = "08004.S.12";
// GemStone changes END
	...
	/*
	** com.pivotal.gemfirexd.internal.database.UserUtility
		*/
