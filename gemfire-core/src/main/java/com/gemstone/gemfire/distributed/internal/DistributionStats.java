...
public class DistributionStats implements DMStats {
  ...
  private final static int sentCommitPhase1MessagesId;
  private final static int sentCommitMessagesId;
  private final static int commitPhase1WaitsId;
  ...
  private final static int jgDirAcksReceivedId;
  ...
  static {
    ...
    final String sentCommitPhase1MessagesDesc = "The number of transaction commit phase1 messages that this GemFire system has created to be sent. Note that it is possible for a commit to only create one message even though it will end up being sent to multiple recipients.";
    ...
    final String commitPhase1WaitsDesc = "The number of transaction commit phase1 messages that had to wait for a response before they could complete.";
    ...
    type = f.createType(
      ...
      new StatisticDescriptor[] {
        ...
        f.createLongCounter("commitPhase1Messages", sentCommitPhase1MessagesDesc, "messages"),
        f.createLongCounter("commitMessages", sentCommitMessagesDesc, "messages"),
        f.createLongCounter("commitPhase1Waits", commitPhase1WaitsDesc, "messages"),
        ...
        f.createLongCounter("jgDirAcksReceived", "Number of DirAck acks received", "acks"),
    ...
    sentCommitPhase1MessagesId = type.nameToId("commitPhase1Messages");
    sentCommitMessagesId = type.nameToId("commitMessages");
    commitPhase1WaitsId = type.nameToId("commitPhase1Waits");
    ...
    jgDirAcksReceivedId = type.nameToId("jgDirAcksReceived");
...
//  private final HistogramStats replyWaitHistogram;
  ...
  public DistributionStats(StatisticsFactory f, long statId) {
    this.stats = f.createAtomicStatistics(type, "distributionStats", statId, 0);
...
//    this.replyWaitHistogram = null;
   ...
   * @since 5.0
   */
  public static final long getStatTimeNoCheck() {
 ...
 /**
  ...
  public long getSentCommitPhase1Messages() {
    return this.stats.getLong(sentCommitPhase1MessagesId);
  }
  ...
  public long getCommitPhase1Waits() {
    return this.stats.getLong(commitPhase1WaitsId);
  }
  ...
  /**
   * @see DMStats#incSentCommitPhase1Messages(long)
   */
  public void incSentCommitPhase1Messages(long messages) {
    this.stats.incLong(sentCommitPhase1MessagesId, messages);
  }

  /**
   * @see DMStats#incSentCommitMessages(long)
   */
  ...
  public void incCommitPhase1Waits() {
    this.stats.incLong(commitPhase1WaitsId, 1);
  }
...
//  }
  ...
  {
    stats.incLong(jgDirAcksReceivedId, value);
  }
...
//      this.replyHandoffHistogram.endOp(delta);
  ...
  public PoolStatHelper getSerialProcessorHelper(final LogWriterI18n l) {
    return new PoolStatHelper() {
      public void startJob() {
        incNumSerialThreadJobs(1);
        if (l.finerEnabled()) {
          l.finer("[DM.SerialQueuedExecutor.execute] numSerialThreads=" +
                         getNumSerialThreads());
        }
      }
      public void endJob() {
  ...
  public PoolStatHelper getViewProcessorHelper(final LogWriterI18n l) {
    return new PoolStatHelper() {
      public void startJob() {
        incViewProcessorThreadJobs(1);
        if (l.finerEnabled()) {
          l.finer("[DM.SerialQueuedExecutor.execute] numViewThreads=" +
                         getNumViewThreads());
        }
      }
      public void endJob() {
