...
public class PartitionedRegionStats {
  ...
  final static int fieldId_PUTALLS_COMPLETED;
  final static int fieldId_PUTALL_MSGS_RETRIED;
  final static int fieldId_PUTALL_RETRIES;
