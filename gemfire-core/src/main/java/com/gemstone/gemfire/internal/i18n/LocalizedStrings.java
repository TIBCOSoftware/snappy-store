...
public class LocalizedStrings extends ParentLocalizedStrings {
  ...
  public static final StringId Region_CLOSED_OR_DESTROYED = new StringIdImpl(3636,
      "Region {0} does not exist or has been destroyed");
  ...
  public static final StringId Connection_P2P_MESSAGE_READER_FOR_0 = new StringIdImpl(3656, "P2P message reader for {0}");
  ...
  public static final StringId GemFireVersion_COULD_NOT_READ_PROPERTIES_FROM_RESOURCE_COM_GEMSTONE_GEMFIRE_INTERNAL_0_BECAUSE_1 = new StringIdImpl(3702, "<Could not read properties from resource {0} because: {1}>");
  public static final StringId GemFireVersion_MISSING_PROPERTY_0_FROM_RESOURCE_COM_GEMSTONE_GEMFIRE_INTERNAL_1 = new StringIdImpl(3703, "<Missing property {0} from resource {1}>");
  ...
  public static final StringId SystemAdmin_GEMFIRE_HELP = new StringIdImpl(3746, "{0} requires one of the following command strings:\n{1}\nFor additional help on a command specify it along with the \"{2}\" option.\nThe \"{3}\" option causes gemfire to print out extra information when it fails.\nThe \"{4}\" and \"{5}\" are synonyms that cause gemfire to print out help information instead of performing a task.\nThe \"{6}\" option quiets gemfire down by suppressing extra messages.\nThe \"{7}\" option passes <vmOpt> to the java vm''s command line.");
  public static final StringId SystemAdmin_VERSION_HELP = new StringIdImpl(3747, "Prints {0} product version information.");
  /* 3748 unused unused */
  ...
  public static final StringId SystemAdmin_START_LOCATOR_HELP = new StringIdImpl(3753, "Starts a locator.\nThe \"{0}\" option specifies the port the locator will listen on. It defaults to \"{1}\"\nThe \"{2}\" option specifies the address the locator will listen on. It defaults to listening on all local addresses.\nThe \"{3}\" option can be used to specify the directory the locator will run in.\nThe \"{4}\" option can be used to specify the {5} file for configuring the locator''s distributed system.  The file''s path should be absolute, or relative to the locator''s directory ({3})\nThe \"{6}\" option can be used to specify whether peer locator service should be enabled. True (the default) will enable the service.\nThe \"{7}\" option can be used to specify whether server locator service should be enabled. True (the default) will enable the service.\nThe \"{8}\" option can be used to specify a host name or ip address that will be sent to clients so they can connect to this locator. The default is to use the address the locator is listening on.\nThe \"{9}\" option can be used to set system properties for the locator VM\nThe \"{10}\" option can be used to set vendor-specific VM options and is usually used to increase the size of the locator VM when using multicast.\n");
  ...
  public static final StringId SystemAdmin_CAUSES_GEMFIRE_TO_WRITE_OUTPUT_TO_THE_SPECIFIED_FILE_THE_FILE_IS_OVERWRITTEN_IF_IT_ALREADY_EXISTS = new StringIdImpl(3759, "Causes {0} to write output to the specified file. The file is overwritten if it already exists.");
  public static final StringId SystemAdmin_CAUSES_GEMFIRE_TO_PRINT_OUT_EXTRA_INFORMATION_WHEN_IT_FAILS_THIS_OPTION_IS_SUPPORTED_BY_ALL_COMMANDS = new StringIdImpl(3760, "Causes {0} to print out extra information when it fails. This option is supported by all commands.");
  public static final StringId SystemAdmin_CAUSES_GEMFIRE_TO_PRINT_DETAILED_INFORMATION_WITH_THE_0_COMMAND_IT_MEANS_STATISTIC_DESCRIPTIONS = new StringIdImpl(3761, "Causes {0} to print detailed information.  With the \"{1}\" command it means statistic descriptions.");
  public static final StringId SystemAdmin_CAUSES_GEMFIRE_0_COMMAND_TO_PRINT_UNFILTERED_RAW_STATISTIC_VALUES_THIS_IS_THE_DEFAULT_FOR_NONCOUNTER_STATISTICS = new StringIdImpl(3762, "Causes {0} \"{1}\" command to print unfiltered, raw, statistic values. This is the default for non-counter statistics.");
  public static final StringId SystemAdmin_CAUSES_GEMFIRE_0_COMMAND_TO_PRINT_THE_RATE_OF_CHANGE_PER_SECOND_FOR_STATISTIC_VALUES_THIS_IS_THE_DEFAULT_FOR_COUNTER_STATISTICS = new StringIdImpl(3763, "Causes {0} \"{1}\" command to print the rate of change, per second, for statistic values. This is the default for counter statistics.");
  public static final StringId SystemAdmin_CAUSES_GEMFIRE_0_COMMAND_TO_PRINT_THE_RATE_OF_CHANGE_PER_SAMPLE_FOR_STATISTIC_VALUES = new StringIdImpl(3764, "Causes {0} \"{1}\" command to print the rate of change, per sample, for statistic values.");
  public static final StringId SystemAdmin_CAUSES_GEMFIRE_0_COMMAND_TO_NOT_PRINT_STATISTICS_WHOSE_VALUES_ARE_ALL_ZERO = new StringIdImpl(3765, "Causes {0} \"{1}\" command to not print statistics whose values are all zero.");
  ...
  public static final StringId SystemAdmin_CAUSES_GEMFIRE_TO_PRINT_OUT_INFORMATION_INSTEAD_OF_PERFORMING_THE_COMMAND_THIS_OPTION_IS_SUPPORTED_BY_ALL_COMMANDS = new StringIdImpl(3770, "Causes {0} to print out information instead of performing the command. This option is supported by all commands.");
  ...
  public static final StringId AgentConfigImpl_PROPERTY_FILE_FROM_WHICH_AGENT_READS_CONFIGURATION = new StringIdImpl(3820, "Name and path ofÂ the Agent''s properties file from which agent reads configuration");
  ...
  public static final StringId CreateRegionProcessor_CANNOT_CREATE_REGION_0_GATEWAYENABLED_1_BECAUSE_ANOTHER_CACHE_HAS_SAME_REGION_GATEWAYENABLED_2 = new StringIdImpl(4003, "Cannot create region {0} gateway-enabled={1} because another cache ({2}) has the same region gateway-enabled={3}");
  ...
  public static final StringId LocalRegion_ATTEMPTING_TO_CLOSE_THE_BRIDGESERVERS_TO_INDUCE_FAILOVER_OF_THE_CLIENTS = new StringIdImpl(4406, "Attempting to close the BridgeServers to induce failover of the clients.");
  public static final StringId LocalRegion_BRIDGESERVERS_STOPPED_SUCCESSFULLY = new StringIdImpl(4407, "BridgeServers stopped successfully");
  public static final StringId LocalRegion_THE_WAS_A_PROBLEM_IN_STOPPING_BRIDGESERVERS_FAILOVER_OF_CLIENTS_IS_SUSPECT = new StringIdImpl(4408, "The was a problem in stopping BridgeServers. Failover of clients is suspect.");
  ...
  public static final StringId JGroupMembershipManager_MEMBERSHIP_EXPIRING_SUSPECT_MEMBER_0 = new StringIdImpl(4459, "Membership: expiring suspect member <{0}>");
  ...
  public static final StringId PutAll_0_UNEXPECTED_EXCEPTION = new StringIdImpl(4519, "{0}: Unexpected Exception");
  ...
  public static final StringId DLockRequestProcess_DLOCKREQUESTMESSAGE_REQUEST_0_TIMED_OUT_GRANTOR_STATUS_1 = new StringIdImpl(4526, "DLockRequestMessage: request {0} timed out; grantor status = {1}");
  ...
  public static final StringId DSFIDFactory_COULD_NOT_INSTANTIATE_GEMFIREXD_MESSAGE_CLASSID_0_1 = new StringIdImpl(4616, "Could not instantiate GemFireXD message [classId:{0}]:{1}");
  public static final StringId DSFIDFactory_ILLEGAL_ACCESS_FOR_GEMFIREXD_MESSAGE_CLASSID_0_1 = new StringIdImpl(4617, "Illegal access for GemFireXD message [classId:{0}]:{1}");
  public static final StringId DSFIDFactory_UNKNOWN_CLASSID_0_FOR_GEMFIREXD_MESSAGE = new StringIdImpl(4618, "Unknown ClassId [{0}] for GemFireXD message");
  ...
  public static final StringId AbstractRegion_NO_CUSTOM_EVICTION_SET =
      new StringIdImpl(4667, "Custom eviction not enabled for region {0}");

  public static final StringId ManagementService_Not_Initialized = new StringIdImpl(
      4668, "Management Service not initialized: {0}");
  ...
  public static final StringId GatewayImpl_EVENT_QUEUE_ALERT_OPERATION_0_REGION_1_KEY_2_VALUE_3_TIME_4 = new StringIdImpl(4673, "{0} event for region={1} key={2} value={3} callbackArg={4} was in the queue for {5} milliseconds");
  ...
  public static final StringId CONNECTION_DISTRIBUTOR_THREAD = new StringIdImpl(4787, "GemFireXD Connection open/close distributor thread");
  public static final StringId CONNECTION_CHANGE_PROCESS_FAILED = new StringIdImpl(4788, "GemFireXD Connection distributor thread: Exception in distributing connection change on remote nodes or unknown exception in thread");
  ...
  //4810 is free
  public static final StringId GatewayImpl_EVENT_QUEUE_DISPATCH_FAILED = new StringIdImpl(
      4811,
      "During normal processing, unsuccessfully dispatched {0} events (batch #{1})"); 
  public static final StringId GatewayHubImpl_HAS_BEEN_STOPPED = new StringIdImpl(4812, "Gateway hub has been stopped");
  public static final StringId GfxdServerLauncher_STARTING_NET_SERVER = new StringIdImpl(4813, "Starting {0} server for {1} at address {2}[{3}]");
  public static final StringId GfxdServerLauncher_UNKNOWN_ARGUMENT = new StringIdImpl(4814, "Unknown argument: {0}={1}");
  ...
  public static final StringId TXEntry_UA_NOT_SUPPORTED = new StringIdImpl(4818, "Transactions do not support UserAttributes in Region entries");
  public static final StringId TXStateProxy_ROLLBACK_ON_NODE_0_FAILED = new StringIdImpl(4819, "Rollback operation on node {0} failed");
  ...
  public static final StringId PartitionedRegion_TRANSACTIONAL_DATA_MOVED_DUE_TO_REBALANCING = new StringIdImpl(4821, "Transactional data moved, due to rebalancing for key {0} in region {1}.");
  ...
  public static final StringId TX_CONFLICT_ON_OBJECT = new StringIdImpl(4823,
      "Conflict detected on object [{0}] for mode {1}");
  public static final StringId TX_CONFLICT_LOCK_ILLEGAL = new StringIdImpl(4824,
      "Conflicting due to illegal lock state for object [{0}] for mode {1}: {2}");
  ...
  public static final StringId TXState_FUNCTION_WITH_NO_RESULT_NOT_SUPPORTED_IN_A_TRANSACTION =
    new StringIdImpl(4827, "Function returning no result is not allowed in a transaction");
  ...
  public static final StringId RemotePutMessage_0__PROCESSED__1 = new StringIdImpl(4839, "{0}  processed  {1}");
  ...
  public static final StringId RemoteFetchEntryMessage_0__PROCESSED__1 = new StringIdImpl(4841, "{0}  processed  {1}");
  ...
  public static final StringId RemoteSizeMessage_0_PROCESSOR_NOT_FOUND = new StringIdImpl(4845, "{0} processor not found");
  public static final StringId RemoteSizeMessage_0__PROCESSED__1 = new StringIdImpl(4846, "{0}  processed  {1}");
  ...
  public static final StringId CreateRegionProcessor_CREATING_0 = new StringIdImpl(4852, "Creating region {0}");
  ...
  public static final StringId DISTRIBUTED_SYSTEM_RECONNECTING = new StringIdImpl(4874, "Attempting to reconnect to the distributed system.  This is attempt #{0}.");
  ...
  /* 4877 - 4880 are unused */

  public static final StringId Gfxd_AUTHENTICATION__NO_CREDENTIAL_INITIALIZER = new StringIdImpl(4881,"AuthenticationServiceBase::getCredentials: {0} not implemented by the user plugin. {1} prefixed properties should be handled by {2} interface ");
  public static final StringId LocalLock_Waiting = new StringIdImpl(4882,
      "{0}: {1} secs elapsed while waiting for {2} lock on {3}, lock: {4}, remaining: {5}ms");
  public static final StringId Gfxd_GATEWAY_SYNCHRONIZER__1 = new StringIdImpl(4883,
  ...
  public static final StringId AuthorizeRequest_NOT_AUTHORIZED_TO_PERFORM_INVALIDATE_OPERATION_ON_REGION_0 = new StringIdImpl(4889, "Not authorized to perform INVALIDATE operation on region {0}");

  /* 4890 - 4892 are unused */
  ...
  public static final StringId CacheServerLauncher_EVICTION_HEAP_PERCENTAGE =
      new StringIdImpl(4900, "<eviction-heap-percentage>  Sets the eviction heap "
  ...
  public static final StringId AbstractDistributionConfig_OFF_HEAP_MEMORY_SIZE_0 = new StringIdImpl(4901, "The amount of off-heap memory to be allocated for GemFire. Value is <n>[g|m], where <n> is the size and [g|m] specifies the units in gigabytes or megabytes. Defaults to \"{0}\".");
  public static final StringId CacheServerLauncher_CommandLine = new StringIdImpl(
      4902, "Starting {0} with command {1}");
  public static final StringId QueueManagerImpl_COULD_NOT_RETRIEVE_LIST_OF_SERVERS_FOR_SUBSCRIPTION_0 = new StringIdImpl(4903, "Could not retrieve the list of servers for subscription. {0}");
  public static final StringId CacheServerLauncher_CRITICAL_OFF_HEAP_PERCENTAGE =
      new StringIdImpl(4904, "<critical-Off-heap-percentage>  Sets the critical off-heap "
  ...
  public static final StringId CacheServerLauncher_EVICTION_OFF_HEAP_PERCENTAGE =
      new StringIdImpl(4905, "<eviction-off-heap-percentage>  Sets the eviction heap "
          + "threshold limit of the Resource Manager above which the eviction "
          ...
          + "<resource-manager> element of the \"cache-xml-file\"");
  public static final StringId AbstractDistributionConfig_LOCK_MEMORY = new StringIdImpl(4906, "Locks heap and off-heap memory pages into RAM, thereby preventing the operating system from swapping them out to disk.");
  public static final StringId CacheServerLauncher_LOCK_MEMORY = new StringIdImpl(4907, "-lock-memory Locks heap and off-heap memory pages into RAM, thereby preventing the operating system from swapping them out to disk.");

  /* 4908 - 4999 are unused */
  ...
  public static final StringId LocalRegion_A_DISKACCESSEXCEPTION_HAS_OCCURED_WHILE_WRITING_TO_THE_DISK_FOR_DISKSTORE_0_THE_DISKSTORE_WILL_BE_CLOSED = new StringIdImpl(5029, "A DiskAccessException has occurred while writing to disk store {0}. The disk store will be closed.");
  ...
  public static final StringId CacheServerLauncher_CRITICAL_HEAP_PERCENTAGE =
      new StringIdImpl(5074, "<critical-heap-percentage>  Sets the critical heap "
  ...
  public static final StringId Gateway_INVALID_CONCURRENCY_LEVEL = new StringIdImpl(5132, "Gateway {0} must define the \"concurrency-level\" attribute greater than or equal to " + Gateway.DEFAULT_CONCURRENCY_LEVEL + " instead of the requested {1}");
  ...
  public static final StringId PartitionRegion_NON_COLOCATED_REGIONS_1_2_CANNOT_HAVE_SAME_PARALLEL_GATEWAY_SENDER_ID_2 = new StringIdImpl(5178, "Non colocated regions \"{0}\", \"{1}\" cannot have the same parallel gateway sender id \"{2}\" configured." );
  ...
  public static final StringId GatewayEventProcessor_EVENT_0_IS_NOT_ADDED_TO_QUEUE = new StringIdImpl(5224, "event {0} is not added to queue.");
  ...
  public static final StringId Oplog_PreAllocate_Failure = new StringIdImpl(5419, "Could not pre-allocate file {0} with size={1}");
  ...
  public static final StringId LocalRegion_REGION_IS_BEING_DESTROYED_WAITING_FOR_PARALLEL_QUEUE_TO_DRAIN = new StringIdImpl(5440, "Region is being destroyed. Waiting for parallel queue to drain.");
  ...
  public static final StringId DistributionManager_DISTRIBUTIONMANAGER_MEMBER_0_IS_1_EQUIVALENT = new StringIdImpl(5450,"Member {0} is {1}equivalent or in the same redundancy zone.");
  public static final StringId BucketAdvisor_WAITING_FOR_PRIMARY = new StringIdImpl(5451,"{0} secs have elapsed waiting for a primary for bucket {1}. Current bucket owners {2}");
  public static final StringId BucketAdvisor_WAITING_FOR_PRIMARY_DONE = new StringIdImpl(5452,"Wait for primary completed");
  public static final StringId LocalRegion_EXCEPTION_OCCURRED_IN_EVENTCALLBACK = new StringIdImpl(5453, "Exception occurred in EventCallback");
  public static final StringId DiskStoreImpl_DELETE_ON_RECOVERY = new StringIdImpl(5454,"Deleted {0} on recovery of disk store {1} because it is not in the metadata.");
  public static final StringId DiskStoreImpl_FATAL_ERROR_ON_FLUSH = new StringIdImpl(5455,"Fatal error from asynchronous flusher thread");
  
  public static final StringId DistributedPutAllOperation_MISSING_VERSION = new StringIdImpl(5456,"memberID cannot be null for persistent regions: {0}");
  
  public static final StringId Oplog_PreAllocate_Failure_Init = new StringIdImpl(5457, "Could not create and pre grow file in dir {0} with size={1}");
  public static final StringId Server_Ping_Failure = new StringIdImpl(5458, "Could not ping one of the following servers: {0}");
  public static final StringId Oplog_Close_Failed = new StringIdImpl(5459, "Failed to close file {0}");
  public static final StringId DiskStoreImpl_OplogSize_Exceeds_DiskDirSize =
      new StringIdImpl(5460, "Cannot create oplogs with size {0}MB which is "
          + "greater than the maximum size {1}MB for store directory ''{2}''");
  public static final StringId TXStateProxy_CANNOT_ROLLBACK_AFTER_COMMIT =
      new StringIdImpl(5461, "{0} ignored rollback for transaction that has "
  ...
  public static final StringId HOPLOG_HDFS_COMPACTION_OVERLOADED = new StringIdImpl(5502, "Too many pending tasks for {0}. Skipping compaction request for {1}");
  public static final StringId HOPLOG_FLUSH_OPERATION_FAILED = new StringIdImpl(5503, "IO error while trying to flush buffer and create hoplog.");
  public static final StringId HOPLOG_HOPLOG_REMOVE_FAILED = new StringIdImpl(5504, "IO error while trying to remove hoplog.");
  ...
  public static final StringId HOPLOG_NOT_STARTED_YET = new StringIdImpl(5518, "HDFS store is not started yet. GemfireXD is running without HDFS.");
  ...
  /** MemScale (off-heap) 5700 - 5800*/
  public static final StringId MEMSCALE_JVM_INCOMPATIBLE_WITH_OFF_HEAP = new StringIdImpl(5700,"Your Java virtual machine is incompatible with off-heap memory.  Please refer to {0} documentation for suggested JVMs.");
  public static final StringId MEMSCALE_EVICTION_INIT_FAIL = new StringIdImpl(5701,"Cannot initialize the off-heap evictor.  There is no off-heap memory available for eviction.");
  
  public static final StringId PartitionAttributesImpl_CANNOT_DETERMINE_LOCAL_MAX_MEMORY_FOR_PARTITION_ATTRIBUTE_SINCE_NO_OFF_HEAP_MEMORY_HAS_BEEN_ALLOCATED = new StringIdImpl(5801, "Cannot determine local max memory for partition attribute since no off-heap memory has been allocated");
  public static final StringId PartitionAttributesImpl_REDUCED_LOCAL_MAX_MEMORY_FOR_PARTITION_ATTRIBUTES_WHEN_SETTING_FROM_AVAILABLE_OFF_HEAP_MEMORY_SIZE = new StringIdImpl(5802, "Reduced local max memory for partition attribute when setting from available off-heap memory size");
  ...
  public static final StringId DiskStoreImpl_DISK_FULL_WARNING = new StringIdImpl(5804, "The directory {0} part of disk store {1} has low usable space left approx({2} MB)");
  public static final StringId LOGDIR_FULL_WARNING = new StringIdImpl(5805, "The log directory {0} has low usable space left approx({1} MB)");
  public static final StringId OffHeapMemoryMonitor_NO_OFF_HEAP_MEMORY_HAS_BEEN_CONFIGURED = new StringIdImpl(5806, "No off-heap memory has been configured.");
  ...
  public static final StringId GFXD_KERBEROS_KEYTAB_UNDEF = new StringIdImpl(5614, "Gemfire XD kerberos keytab file is not configured");
  ...
  public static final StringId GemFireCache_INIT_CLEANUP_FAILED_FOR_REGION_0 = new StringIdImpl(5831, "Initialization failed for Region {0}");

  public static final StringId DiskWriteAttributesFactory_DISK_USAGE_WARNING_INVALID_0 = new StringIdImpl(5832, "Disk usage warning percentage must be set to a value between 0-100.  The value {0} is invalid.");
  public static final StringId DiskWriteAttributesFactory_DISK_USAGE_CRITICAL_INVALID_0 = new StringIdImpl(5833, "Disk usage critical percentage must be set to a value between 0-100.  The value {0} is invalid.");

  public static final StringId DiskStoreMonitor_LOG_DISK_NORMAL = new StringIdImpl(5834, "The disk volume {0} for log files has returned to normal usage levels and is {1} full.");
  public static final StringId DiskStoreMonitor_LOG_DISK_WARNING = new StringIdImpl(5835, "The disk volume {0} for log files has exceeded the warning usage threshold and is {1} full.");
  public static final StringId DiskStoreMonitor_DISK_WARNING = new StringIdImpl(5836, "The disk volume {0} for disk store {1} has exceeded the warning usage threshold and is {2} full");
  public static final StringId DiskStoreMonitor_DISK_CRITICAL = new StringIdImpl(5837, "The disk volume {0} for disk store {1} has exceeded the critical usage threshold and is {2} full");
  public static final StringId DiskStoreMonitor_DISK_NORMAL = new StringIdImpl(5838, "The disk volume {0} for disk store {1} has returned to normal usage levels and is {2} full");
  public static final StringId DiskStoreMonitor_ERR = new StringIdImpl(5839, "The DiskStore Monitor has encountered an error");
  public static final StringId DiskStoreMonitor_ThreadGroup = new StringIdImpl(5840, "DiskStoreMonitorss");

  public static final StringId InternalInstantiator_REGISTERED = new StringIdImpl(5850, "Instantiator registered with id {0} class {1}");
  public static final StringId InternalInstantiator_REGISTERED_HOLDER = new StringIdImpl(5851, "Instantiator registered with holder id {0} class {1}");
  public static final StringId RegisterInstantiators_BAD_CLIENT = new StringIdImpl(5852, "Client {0} failed to register instantiators: {1}");
  public static final StringId GatewayReceiver_EXCEPTION_WHILE_PROCESSING_BATCH = new StringIdImpl(5853, "Exception occurred while processing a batch on the receiver running on DistributedSystem with Id: {0}, DistributedMember on which the receiver is running: {1}");

  public static final StringId DiskStoreAttributesCreation_DISK_USAGE_WARN_ARE_NOT_THE_SAME = new StringIdImpl(5860, "Disk usage warning percentages of disk store {0} are not the same");
  public static final StringId DiskStoreAttributesCreation_DISK_USAGE_CRITICAL_ARE_NOT_THE_SAME = new StringIdImpl(5861, "Disk usage critical percentages of disk store {0} are not the same");

  public static final StringId QueueManagerImpl_COULD_NOT_FIND_SERVER_TO_CREATE_PRIMARY_CLIENT_QUEUE = new StringIdImpl(5862, "Could not find server to create primary client queue. Number of exclude server is {0} and exception is {1}");
  public static final StringId QueueManagerImpl_COULD_NOT_FIND_SERVER_TO_CREATE_REDUNDANT_CLIENT_QUEUE = new StringIdImpl(5863, "Could not find server to create redundant client queue. Number of exclude server is {0} and exception is {1}");
  public static final StringId QueueManagerImpl_SUBSCRIPTION_ENDPOINT_CRASHED_SCHEDULING_RECOVERY = new StringIdImpl(5864, "{0} subscription endpoint {1} crashed. Scheduling recovery.");
  public static final StringId QueueManagerImpl_CACHE_CLIENT_UPDATER_FOR_ON_ENDPOINT_EXITING_SCHEDULING_RECOVERY = new StringIdImpl(5865, "Cache client updater for {0} on endpoint {1} exiting. Scheduling recovery.");
  //SubscriptionManager redundancy satisfier - primary endpoint has been lost. Attempting to recover
  public static final StringId QueueManagerImpl_SUBSCRIPTION_MANAGER_REDUNDANCY_SATISFIER_PRIMARY_ENDPOINT_HAS_BEEN_LOST_ATTEMPTIMG_TO_RECOVER = new StringIdImpl(5866, "SubscriptionManager redundancy satisfier - primary endpoint has been lost. Attempting to recover.");
  public static final StringId QueueManagerImpl_SUBSCRIPTION_MANAGER_REDUNDANCY_SATISFIER_REDUNDANT_ENDPOINT_HAS_BEEN_LOST_ATTEMPTIMG_TO_RECOVER = new StringIdImpl(5867, "SubscriptionManager redundancy satisfier - redundant endpoint has been lost. Attempting to recover.");
  public static final StringId AbstractGatewaySender_META_REGION_CREATION_EXCEPTION_0 = new StringIdImpl(5868, "{0}: Caught the following exception attempting to create gateway event id index metadata region:");
  public static final StringId AbstractGatewaySender_FAILED_TO_LOCK_META_REGION_0 = new StringIdImpl(5869, "{0}: Failed to lock gateway event id index metadata region");

  public static final StringId GatewayReceiver_PDX_CONFIGURATION = new StringIdImpl(5870, "This gateway receiver has received a PDX type from {0} that does match the existing PDX type. This gateway receiver will not process any more events, in order to prevent receiving objects which may not be deserializable.");
  public static final StringId Gateway_CONFIGURED_SOCKET_READ_TIMEOUT_TOO_LOW = new StringIdImpl(5871, "{0} cannot configure socket read timeout of {1} milliseconds because it is less than the minimum of {2} milliseconds. The default will be used instead.");
  public static final StringId Gateway_OBSOLETE_SYSTEM_POPERTY = new StringIdImpl(5872, "Obsolete java system property named {0} was set to control {1}. This property is no longer supported. Please use the GemFire API instead.");
  ...
  public static final StringId AbstractDistributionConfig_MEMORY_SIZE = new StringIdImpl(90008, "Total off-heap memory which server regions and various operator can occupy");
}
