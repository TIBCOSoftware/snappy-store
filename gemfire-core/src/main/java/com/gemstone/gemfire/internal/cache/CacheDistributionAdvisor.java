...
//  private static final int IS_GII_PROVIDER_MASK = 0x4000;
   ...
   */
  final Set<InternalDistributedMember> adviseUpdate(final EntryEventImpl event)
  ...
  final Set<InternalDistributedMember> adviseCreateNullValue() {
    {
  ...
  private static final ProfileVisitor<Void> hasUninitializedReplicateVisitor =
...
//         (allEvents() && this.hasCacheListener);
  ...
  public final Set adviseSerialAsyncEventQueueOrGatewaySender(
    ...
    return adviseFilter(new Filter() {
      private final boolean containsAny(final Set<String> ids,
  ...
  public Map<InternalDistributedMember, PersistentMemberID>
