...
LD_LIBRARY_PATH=$LD_LIBRARY_PATH:${thrftLibPath}:${boostLibPath}:${snappClientLibPath}:${_snappyNativeDir}/Debug
...
g++ -std=c++11 -I"${headerLoc}" -I"${boostHeadeLoc}" -O0 -g -Wall -c -fmessage-length=0 -MMD -MP -MF"${_testDir}/failoverTest_NewServer.d" -MT"${_testDir}/failoverTest_NewServer.o" -o "${_testDir}/failoverTest_NewServer.o" "${_testDir}/failoverTest_NewServer.cpp"
