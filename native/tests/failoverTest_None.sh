...
g++ -std=c++11 -I"${headerLoc}" -I"${boostHeadeLoc}" -O0 -g -Wall -c -fmessage-length=0 -MMD -MP -MF"${_testDir}/failoverTest_None.d" -MT"${_testDir}failoverTest_None.o" -o "${_testDir}failoverTest_None.o" "${_testDir}failoverTest_None.cpp"
