...
class LocatorServiceIfSingletonFactory : virtual public LocatorServiceIfFactory {
 public:
  LocatorServiceIfSingletonFactory(const ::std::shared_ptr<LocatorServiceIf>& iface) : iface_(iface) {}
 ...
 protected:
  ::std::shared_ptr<LocatorServiceIf> iface_;
};
...
class LocatorServiceClient : virtual public LocatorServiceIf {
 public:
  LocatorServiceClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  LocatorServiceClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
...
class LocatorServiceProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  LocatorServiceProcessor(::std::shared_ptr<LocatorServiceIf> iface) :
    iface_(iface) {
...
class LocatorServiceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  LocatorServiceProcessorFactory(const ::std::shared_ptr< LocatorServiceIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::std::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::std::shared_ptr< LocatorServiceIfFactory > handlerFactory_;
};

class LocatorServiceMultiface : virtual public LocatorServiceIf {
 public:
  LocatorServiceMultiface(std::vector<std::shared_ptr<LocatorServiceIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~LocatorServiceMultiface() {}
 protected:
  std::vector<std::shared_ptr<LocatorServiceIf> > ifaces_;
  LocatorServiceMultiface() {}
  void add(::std::shared_ptr<LocatorServiceIf> iface) {
