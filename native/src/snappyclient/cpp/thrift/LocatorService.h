...
class LocatorServiceIfSingletonFactory : virtual public LocatorServiceIfFactory {
 public:
  LocatorServiceIfSingletonFactory(const ::apache::thrift::stdcxx::shared_ptr<LocatorServiceIf>& iface) : iface_(iface) {}
 ...
 protected:
  ::apache::thrift::stdcxx::shared_ptr<LocatorServiceIf> iface_;
};
...
class LocatorServiceClient : virtual public LocatorServiceIf {
 public:
  LocatorServiceClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  LocatorServiceClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
...
class LocatorServiceProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  LocatorServiceProcessor(::apache::thrift::stdcxx::shared_ptr<LocatorServiceIf> iface) :
    iface_(iface) {
...
class LocatorServiceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  LocatorServiceProcessorFactory(const ::apache::thrift::stdcxx::shared_ptr< LocatorServiceIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::apache::thrift::stdcxx::shared_ptr< LocatorServiceIfFactory > handlerFactory_;
};

class LocatorServiceMultiface : virtual public LocatorServiceIf {
 public:
  LocatorServiceMultiface(std::vector<apache::thrift::stdcxx::shared_ptr<LocatorServiceIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~LocatorServiceMultiface() {}
 protected:
  std::vector<apache::thrift::stdcxx::shared_ptr<LocatorServiceIf> > ifaces_;
  LocatorServiceMultiface() {}
  void add(::apache::thrift::stdcxx::shared_ptr<LocatorServiceIf> iface) {
