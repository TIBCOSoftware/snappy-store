...
std::ostream& operator<<(std::ostream& out, const SnappyExceptionData& obj)
{
  obj.printTo(out);
  return out;
}
...
SnappyExceptionData::SnappyExceptionData( SnappyExceptionData&& other140) {
...
SnappyExceptionData& SnappyExceptionData::operator=(SnappyExceptionData&& other142) {
