...
std::ostream& operator<<(std::ostream& out, const CatalogTableObject& obj)
{
  obj.printTo(out);
  return out;
}
...
CatalogTableObject::CatalogTableObject( CatalogTableObject&& other401) {
...
CatalogTableObject& CatalogTableObject::operator=(CatalogTableObject&& other403) {
