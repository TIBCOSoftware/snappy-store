...
std::ostream& operator<<(std::ostream& out, const CatalogMetadataDetails& obj)
{
  obj.printTo(out);
  return out;
}
...
CatalogMetadataDetails::CatalogMetadataDetails( CatalogMetadataDetails&& other493) {
...
CatalogMetadataDetails& CatalogMetadataDetails::operator=(CatalogMetadataDetails&& other495) {
