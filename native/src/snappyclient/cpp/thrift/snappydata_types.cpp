...
const std::map<int, const char*> _SnappyType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(27, _kSnappyTypeValues, _kSnappyTypeNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));

std::ostream& operator<<(std::ostream& out, const SnappyType::type& val) {
  std::map<int, const char*>::const_iterator it = _SnappyType_VALUES_TO_NAMES.find(val);
  if (it != _SnappyType_VALUES_TO_NAMES.end()) {
    out << it->second;
  } else {
...
std::string to_string(const SnappyType::type& val) {
  std::map<int, const char*>::const_iterator it = _SnappyType_VALUES_TO_NAMES.find(val);
  if (it != _SnappyType_VALUES_TO_NAMES.end()) {
...
const std::map<int, const char*> _TransactionAttribute_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(5, _kTransactionAttributeValues, _kTransactionAttributeNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));

std::ostream& operator<<(std::ostream& out, const TransactionAttribute::type& val) {
  std::map<int, const char*>::const_iterator it = _TransactionAttribute_VALUES_TO_NAMES.find(val);
  if (it != _TransactionAttribute_VALUES_TO_NAMES.end()) {
    out << it->second;
  } else {
    out << static_cast<int>(val);
  }
...
std::string to_string(const TransactionAttribute::type& val) {
  std::map<int, const char*>::const_iterator it = _TransactionAttribute_VALUES_TO_NAMES.find(val);
  if (it != _TransactionAttribute_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
  } else {
...
const std::map<int, const char*> _RowIdLifetime_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(5, _kRowIdLifetimeValues, _kRowIdLifetimeNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));

std::ostream& operator<<(std::ostream& out, const RowIdLifetime::type& val) {
  std::map<int, const char*>::const_iterator it = _RowIdLifetime_VALUES_TO_NAMES.find(val);
  if (it != _RowIdLifetime_VALUES_TO_NAMES.end()) {
    out << it->second;
  } else {
    out << static_cast<int>(val);
  }
...
std::string to_string(const RowIdLifetime::type& val) {
  std::map<int, const char*>::const_iterator it = _RowIdLifetime_VALUES_TO_NAMES.find(val);
  if (it != _RowIdLifetime_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
  } else {
...
const std::map<int, const char*> _ServiceFeature_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(88, _kServiceFeatureValues, _kServiceFeatureNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));

std::ostream& operator<<(std::ostream& out, const ServiceFeature::type& val) {
  std::map<int, const char*>::const_iterator it = _ServiceFeature_VALUES_TO_NAMES.find(val);
  if (it != _ServiceFeature_VALUES_TO_NAMES.end()) {
    out << it->second;
  } else {
    out << static_cast<int>(val);
  }
...
std::string to_string(const ServiceFeature::type& val) {
  std::map<int, const char*>::const_iterator it = _ServiceFeature_VALUES_TO_NAMES.find(val);
  if (it != _ServiceFeature_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
  } else {
...
const std::map<int, const char*> _ServiceFeatureParameterized_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(13, _kServiceFeatureParameterizedValues, _kServiceFeatureParameterizedNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));

std::ostream& operator<<(std::ostream& out, const ServiceFeatureParameterized::type& val) {
  std::map<int, const char*>::const_iterator it = _ServiceFeatureParameterized_VALUES_TO_NAMES.find(val);
  if (it != _ServiceFeatureParameterized_VALUES_TO_NAMES.end()) {
    out << it->second;
  } else {
    out << static_cast<int>(val);
  }
...
std::string to_string(const ServiceFeatureParameterized::type& val) {
  std::map<int, const char*>::const_iterator it = _ServiceFeatureParameterized_VALUES_TO_NAMES.find(val);
  if (it != _ServiceFeatureParameterized_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
  } else {
...
const std::map<int, const char*> _ServiceMetaDataCall_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(22, _kServiceMetaDataCallValues, _kServiceMetaDataCallNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));

std::ostream& operator<<(std::ostream& out, const ServiceMetaDataCall::type& val) {
  std::map<int, const char*>::const_iterator it = _ServiceMetaDataCall_VALUES_TO_NAMES.find(val);
  if (it != _ServiceMetaDataCall_VALUES_TO_NAMES.end()) {
    out << it->second;
  } else {
    out << static_cast<int>(val);
  }
...
std::string to_string(const ServiceMetaDataCall::type& val) {
  std::map<int, const char*>::const_iterator it = _ServiceMetaDataCall_VALUES_TO_NAMES.find(val);
  if (it != _ServiceMetaDataCall_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
  } else {
...
const std::map<int, const char*> _SecurityMechanism_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(2, _kSecurityMechanismValues, _kSecurityMechanismNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));

std::ostream& operator<<(std::ostream& out, const SecurityMechanism::type& val) {
  std::map<int, const char*>::const_iterator it = _SecurityMechanism_VALUES_TO_NAMES.find(val);
  if (it != _SecurityMechanism_VALUES_TO_NAMES.end()) {
    out << it->second;
  } else {
    out << static_cast<int>(val);
  }
...
std::string to_string(const SecurityMechanism::type& val) {
  std::map<int, const char*>::const_iterator it = _SecurityMechanism_VALUES_TO_NAMES.find(val);
  if (it != _SecurityMechanism_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
  } else {
...
const std::map<int, const char*> _ServerType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(9, _kServerTypeValues, _kServerTypeNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));

std::ostream& operator<<(std::ostream& out, const ServerType::type& val) {
  std::map<int, const char*>::const_iterator it = _ServerType_VALUES_TO_NAMES.find(val);
  if (it != _ServerType_VALUES_TO_NAMES.end()) {
    out << it->second;
  } else {
    out << static_cast<int>(val);
  }
...
std::string to_string(const ServerType::type& val) {
  std::map<int, const char*>::const_iterator it = _ServerType_VALUES_TO_NAMES.find(val);
  if (it != _ServerType_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
  } else {
...
const std::map<int, const char*> _CursorUpdateOperation_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(3, _kCursorUpdateOperationValues, _kCursorUpdateOperationNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));

std::ostream& operator<<(std::ostream& out, const CursorUpdateOperation::type& val) {
  std::map<int, const char*>::const_iterator it = _CursorUpdateOperation_VALUES_TO_NAMES.find(val);
  if (it != _CursorUpdateOperation_VALUES_TO_NAMES.end()) {
    out << it->second;
  } else {
    out << static_cast<int>(val);
  }
...
std::string to_string(const CursorUpdateOperation::type& val) {
  std::map<int, const char*>::const_iterator it = _CursorUpdateOperation_VALUES_TO_NAMES.find(val);
  if (it != _CursorUpdateOperation_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
  } else {
