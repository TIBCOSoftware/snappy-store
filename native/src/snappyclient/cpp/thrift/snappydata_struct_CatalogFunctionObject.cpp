...
std::ostream& operator<<(std::ostream& out, const CatalogFunctionObject& obj)
{
  obj.printTo(out);
  return out;
}
...
CatalogFunctionObject::CatalogFunctionObject( CatalogFunctionObject&& other411) {
...
CatalogFunctionObject& CatalogFunctionObject::operator=(CatalogFunctionObject&& other413) {
