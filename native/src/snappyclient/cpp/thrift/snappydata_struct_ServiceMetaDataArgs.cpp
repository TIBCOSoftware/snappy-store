...
std::ostream& operator<<(std::ostream& out, const ServiceMetaDataArgs& obj)
{
  obj.printTo(out);
  return out;
}
...
ServiceMetaDataArgs::ServiceMetaDataArgs( ServiceMetaDataArgs&& other108) {
...
ServiceMetaDataArgs& ServiceMetaDataArgs::operator=(ServiceMetaDataArgs&& other110) {
