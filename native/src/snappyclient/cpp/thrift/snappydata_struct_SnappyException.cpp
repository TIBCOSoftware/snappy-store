...
std::ostream& operator<<(std::ostream& out, const SnappyException& obj)
{
  obj.printTo(out);
  return out;
}
...
SnappyException::SnappyException( SnappyException&& other150) : TException() {
...
SnappyException& SnappyException::operator=(SnappyException&& other152) {
