...
std::ostream& operator<<(std::ostream& out, const CatalogSchemaObject& obj)
{
  obj.printTo(out);
  return out;
}
...
CatalogSchemaObject::CatalogSchemaObject( CatalogSchemaObject&& other333) {
...
CatalogSchemaObject& CatalogSchemaObject::operator=(CatalogSchemaObject&& other335) {
