...
std::ostream& operator<<(std::ostream& out, const OutputParameter& obj)
{
  obj.printTo(out);
  return out;
}
...
OutputParameter::OutputParameter( OutputParameter&& other233) {
...
OutputParameter& OutputParameter::operator=(OutputParameter&& other235) {
