...
std::ostream& operator<<(std::ostream& out, const UpdateResult& obj)
{
  obj.printTo(out);
  return out;
}
...
UpdateResult::UpdateResult( UpdateResult&& other281) {
...
UpdateResult& UpdateResult::operator=(UpdateResult&& other283) {
