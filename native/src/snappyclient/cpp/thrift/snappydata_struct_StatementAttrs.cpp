...
std::ostream& operator<<(std::ostream& out, const StatementAttrs& obj)
{
  obj.printTo(out);
  return out;
}
...
StatementAttrs::StatementAttrs( StatementAttrs&& other182) {
...
StatementAttrs& StatementAttrs::operator=(StatementAttrs&& other184) {
