...
std::ostream& operator<<(std::ostream& out, const OpenConnectionArgs& obj)
{
  obj.printTo(out);
  return out;
}
...
OpenConnectionArgs::OpenConnectionArgs( OpenConnectionArgs&& other121) {
...
OpenConnectionArgs& OpenConnectionArgs::operator=(OpenConnectionArgs&& other123) {
