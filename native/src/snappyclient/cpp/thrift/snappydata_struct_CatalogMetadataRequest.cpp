...
std::ostream& operator<<(std::ostream& out, const CatalogMetadataRequest& obj)
{
  obj.printTo(out);
  return out;
}
...
CatalogMetadataRequest::CatalogMetadataRequest( CatalogMetadataRequest&& other443) {
...
CatalogMetadataRequest& CatalogMetadataRequest::operator=(CatalogMetadataRequest&& other445) {
