...
std::ostream& operator<<(std::ostream& out, const CatalogPartitionObject& obj)
{
  obj.printTo(out);
  return out;
}
...
CatalogPartitionObject::CatalogPartitionObject( CatalogPartitionObject&& other431) {
...
CatalogPartitionObject& CatalogPartitionObject::operator=(CatalogPartitionObject&& other433) {
