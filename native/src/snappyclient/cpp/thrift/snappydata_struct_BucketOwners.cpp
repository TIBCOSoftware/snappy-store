...
std::ostream& operator<<(std::ostream& out, const BucketOwners& obj)
{
  obj.printTo(out);
  return out;
}
...
BucketOwners::BucketOwners( BucketOwners&& other309) {
...
BucketOwners& BucketOwners::operator=(BucketOwners&& other311) {
