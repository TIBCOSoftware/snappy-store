...
std::ostream& operator<<(std::ostream& out, const CatalogStorage& obj)
{
  obj.printTo(out);
  return out;
}
...
CatalogStorage::CatalogStorage( CatalogStorage&& other321) {
...
CatalogStorage& CatalogStorage::operator=(CatalogStorage&& other323) {
