...
SQLMessage2<int, int> SQLStateMessage::COLUMN_NOT_FOUND_MSG1;
...
SQLMessage2<int, int> SQLStateMessage::LANG_OUTSIDE_RANGE_FOR_NUMERIC_MSG;
...
SQLMessage2<const char*, int> SQLStateMessage::STRING_TRUNCATED_MSG;
SQLMessage2<const char*, int> SQLStateMessage::NUMERIC_TRUNCATED_MSG;
...
SQLMessage2<int, const char*> SQLStateMessage::INVALID_ATTRIBUTE_VALUE_MSG;
