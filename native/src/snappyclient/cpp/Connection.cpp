...
void ConnectionProperty::staticInitialize() {
  ...
  addProperty_(ClientAttribute::USERNAME, "User name to connect with", nullptr,
      nullptr, F_IS_USER | F_IS_UTF8);
  ...
  addProperty_(ClientAttribute::KEEPALIVE_IDLE, keepAliveIdleHelp, nullptr,
      nullptr, F_NONE);
  addProperty_(ClientAttribute::KEEPALIVE_INTVL, keepAliveIntvlHelp, nullptr,
      nullptr, F_NONE);
  addProperty_(ClientAttribute::KEEPALIVE_CNT, keepAliveCntHelp, nullptr,
      nullptr, F_NONE);
  addProperty_(ClientAttribute::SINGLE_HOP_ENABLED,
      "Enable single hop queries and update/delete DML operations for "
          "partitioned tables (default disabled)", FALSE_TRUE, nullptr,
      F_IS_BOOLEAN);
  addProperty_(ClientAttribute::SINGLE_HOP_MAX_CONNECTIONS,
      singleHopMaxConnHelp, nullptr, nullptr, F_NONE);
  addProperty_(ClientAttribute::DISABLE_STREAMING,
      "Disable streaming of query results from servers to client "
          "(default is false i.e. streaming is enabled)", FALSE_TRUE, nullptr,
      F_IS_BOOLEAN);
  ...
  addProperty_(ClientAttribute::LOG_FILE,
      "Path of the log file for any client side logging for function tracing "
          " or product logs/errors", nullptr, nullptr,
  ...
  addProperty_(ClientAttribute::TX_SYNC_COMMITS,
      "Wait for 2nd phase commit to complete on all nodes instead of "
          ...
          "done (default is false)", FALSE_TRUE, nullptr, F_IS_BOOLEAN);
  ...
  addProperty_(ClientAttribute::DISABLE_THINCLIENT_CANCEL,
      ...
      FALSE_TRUE, nullptr, F_IS_BOOLEAN);
  addProperty_(ClientAttribute::ROUTE_QUERY,
      ...
      TRUE_FALSE, nullptr, F_IS_BOOLEAN);
  ...
  addProperty_(ClientAttribute::SERVER_GROUPS,
      "A connection level property. Restrict connection to servers in the "
          "given server-groups.", FALSE_TRUE, nullptr, F_IS_BOOLEAN);
}
