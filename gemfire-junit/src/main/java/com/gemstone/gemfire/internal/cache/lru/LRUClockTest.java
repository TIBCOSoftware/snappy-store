...
public class LRUClockTest extends junit.framework.TestCase {
  ...
  public LRUClockTest( String name ) {
    super( name );
    this.myTestName = name;
  }

  protected LRUClockTest( String prefix, String methodName ) {
    super( methodName );
  ...
  public static void main( String[] args ) throws Exception {
    junit.textui.TestRunner.run( new TestSuite( LRUClockTest.class ) );
  }
